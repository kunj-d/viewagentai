    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> Sub Menu Manager <small> Here You can manage Menus </small> </h3>
                <br/>
            </div>
                                ...
                                <?php foreach ($list as $key=>$val) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($edit_per == 'yes') { ?>
                                                <a href="<?= $this->config->item('spanel_url') . 'edit-submenu-manager/' . $val->id ?>" class="btn btn-info btn-xs" title="Edit" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i> </a>
                                            <?php } ?>

                                            <?php if ($delete_per == 'yes') { ?>
                                                <a href="javascript:" class="btn btn-danger btn-xs deletelink" title="Delete" data-toggle="tooltip" data-placement="top" data-href="<?= $this->config->item('spanel_url') . 'delete-submenu-manager/' . $val->id ?>"><i class="fa fa-trash-o"></i> </a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
