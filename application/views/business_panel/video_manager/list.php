...
<div class="right_col" role="main">
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> Video Manager <small> Here You can manage Videos </small> </h3>
                <br/>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Default Video's list </h2>

                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="auto">
                            <thead>
                                <tr>
                                ...
                                <?php foreach ($list as $key=>$val) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											<?php 
												$sr_no=  $key+1 ;
												if($this->input->get('per_page') && $this->input->get('per_page')>0){
													$sr_no= $sr_no+$this->input->get('per_page');
												}
												echo $sr_no;
											?>
										</td>
                                        <td style="word-break: break-all;"><?= $val->title ?></td>
                                        <td style="word-break: break-all;"><?= $val->thumbnail_url ?></td>
										<td><?= $val->json_url ?></td>
										<!-- <td><?= $val->route ?></td> -->
                                        ...
                                        <td>
                                            <?php if ($status_per == 'yes') { ?>
                                                <?php if ($val->status == 'inactive') { ?>
                                                    <!--<a href="javascript:" class="btn btn-warning btn-xs statuslink" title="Set Active" data-toggle="tooltip" data-placement="top" data-href="<?= $this->config->item('spanel_url') . 'change-submenu-manager-status/active/' . $val->id ?>"><i class="fa fa-check"></i> </a>-->
                                                <?php } else { ?>
                                                    <!--<a href="javascript:" class="btn btn-warning btn-xs statuslink" title="Set Inactive" data-toggle="tooltip" data-placement="top" data-href="<?= $this->config->item('spanel_url') . 'change-submenu-manager-status/inactive/' . $val->id ?>"><i class="fa fa-ban"></i> </a>-->
                                                    <?php
                                                }
                                            }
                                            ?>
                                            ...
                                            <?php if ($edit_per == 'yes') { ?>
                                                <a href="<?= $this->config->item('spanel_url') . 'edit-video-manager/' . $val->id ?>" class="btn btn-info btn-xs" title="Edit" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i> </a>
                                            <?php } ?>

                                            <?php if ($delete_per == 'yes') { ?>
                                                <a href="javascript:" class="btn btn-danger btn-xs deletelink" title="Delete" data-toggle="tooltip" data-placement="top" data-href="<?= $this->config->item('spanel_url') . 'delete-video-manager/' . $val->id ?>"><i class="fa fa-trash-o"></i> </a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
    ...
    <script type="text/javascript">
        ...
        $('body').delegate(".viewlink", 'click', function() {
            ...
            var posturl = spanel_url + 'view-menu-manager';
