              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
                    <h4 style="text-align:center;">PDF Step By step Guides URLs</h4>
                    <div style="border:1px solid #1ABB9C;">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="guide_urls"><?php if($i==1) {?>URLS<?php }?></span>
                            ...
                            <input name="guide_urls[]" class="form-control col-md-7 col-xs-12" clsss="guide_urls" value="<?=$guide_urls[$i-1]?>"></textarea>
                            </div>
                            <?php if($i==1) {?>
                    ...
                    <div style="border:1px solid #1ABB9C;">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="video_urls"><?php if($i==1) {?>URLS<?php }?></span>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input name="video_urls[]" class="form-control col-md-7 col-xs-12" clsss="video_urls" value="<?=$video_urls[$i-1]?>"></textarea>
                            </div>
                            <?php if($i==1) {?>
