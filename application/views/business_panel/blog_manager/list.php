						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="input-group">
								...
								<select name="product_id">
									<option value="all" <?php if($selected_product_id=='all'){echo "selected";}?> >All</option>
									<?php foreach($all_products as $key=>$product){
										$is_selected = $selected_product_id==$product["id"] ? "selected" : "";
										echo '<option value="'.$product["id"].'" '.$is_selected.'>'.$product["title"].'</option>';
									}?>
								</select>
