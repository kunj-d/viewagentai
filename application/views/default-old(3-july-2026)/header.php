...
<head>
    ...
    <script type='text/javascript' src="<?= $this->config->item('assetsPath') ?>js/jquery.mCustomScrollbar.concat.min.js"></script>
    ...
    <script src="<?php echo $this->config->item('assetsPath') ?>js/daterangepicker.min.js" type="text/javascript"></script>
    <script src="<?php echo $this->config->item('assetsPath') ?>js/jquery.datetimepicker.js" type="text/javascript"></script>
    <script src="<?php echo $this->config->item('assetsPath') ?>js/jquery.magnific-popup.min.js" type="text/javascript"></script>

    <script type='text/javascript' src="https://cdn.datatables.net/1.13.6/js/jquery.dataTables.min.js"></script>
    <script type='text/javascript' src="<?php echo $this->config->item('assetsPath') ?>js/dataTables.bootstrap5.min.js"></script>
...
<body>
    ...
    <header class="header-fixed justify-content-end d-lg-none shadow-none" style="background: transparent">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="d-none">
                <a href="<?php echo base_url('dashboard'); ?>">
                    <img src="<?php echo $web_logo; ?>" class="img-fluid logo-height" style="max-width: 90% !important;" />
                </a>
            </div>
        ...
        <ul class="top-right-items d-none" style="margin-right: 40px;">
            ...
            <li class="top-right-coins d-none " id="coins" data-toggle="tooltip" data-placement="bottom" title="&emsp;  1 Credit = 50 Character &emsp; &nbsp;">
                <div class="user-name d-none d-md-flex ">
                    <form action="<?php echo base_url('integration') ?>" method="post">
                        ...
                        <button type="submit" style="background: transparent;text-decoration: none; border: none; margin-top:11px; color:var(--white-color);">
                            <!--<a href="#" >-->
                ...
                <ul class="outer-sub-menu">
                    <div class="nav-item">
                        <ul class="switch-business p-0 m-auto">
                            <li class="profile style-3 position-static">
                                <a href="#" class="dropdown-toggle w-100 profile-pic rotate1" id="headerDrop" data-bs-toggle="dropdown">
                                    <div class="actice-profile d-flex align-items-center gap-1 justify-content-center w-100">
                                        <div class="icon-logo">
                                            <img id="workspace" src="<?= ($this->session->userdata('business')['logo'] == '' || $this->session->userdata('business')['logo'] == 'default_business_logo.png') ? $uploadPath . 'default_images/default_business_logo.png' : $this->config->item('bucket_url') . $this->session->userdata('business')['logo']  ?>" class="img-fluid">
                                            <?php
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end animated--grow-in businessDropDown " aria-labelledby="dropdownMenuButton1" style="overflow: hidden; inset: 0px auto auto -50px !important;">
                                        <li>
                                            <h6 class="mb-2" style="color: var(--white-color);">Workspace</h6>
                                            <div class="search-bar mb-2">
                                                <input type="text" class="search form-control" id="getBusinesslist" placeholder="Search Workspace...">
                                                <div class="search-icon" style="cursor:pointer;" onClick="getBusinesslist()">
                                            ...
                                            <div class="row align-items-center g-2">
                                                <?php if ($this->session->userdata('logged_in')['id'] == $this->session->userdata('logged_in')['owner_id']) { ?>
                                                    <div class="col-md-5">
                                                        <a href="#modal" class="btn btn-primary dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal"><span class="icon-campaign-name"></span> Add</a>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <a class="btn btn-primary dropdown-item" href="<?= base_url('workspace'); ?>"> <span class="icon-password-view"></span> Manage All</a>
                                                    </div>
                                                <?php } ?>
                                            </div>
                                        </li>
                    ...
                    <li class="nav-item <?php
                        ...
                        <a href="<?= base_url('analyz'); ?>" class="nav-link hover-shadow" id="analyz">
                            <svg width="14" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M0.133789 8.11639H4.83148V20.3532H0.133789V8.11639Z" fill="white" fill-opacity="0.8"/>
                                <path d="M18.3 16.4399C19.2605 14.825 19.0597 12.7103 17.6696 11.3208C16.848 10.4993 15.7707 10.0881 14.6934 10.0881C13.6161 10.0881 12.5395 10.4993 11.7172 11.3208C10.0734 12.9646 10.0734 15.6294 11.7172 17.2732C12.5388 18.0948 13.6161 18.5059 14.6934 18.5059C15.4215 18.5059 16.1434 18.3017 16.793 17.9263L20.3701 21.5034L21.8661 20.0074L18.3 16.4399ZM16.6975 16.3004C16.1619 16.8359 15.4504 17.1302 14.6934 17.1302C13.9365 17.1302 13.2249 16.8353 12.69 16.3004C11.5852 15.1956 11.5852 13.3978 12.69 12.2929C13.2256 11.7574 13.9372 11.4631 14.6934 11.4631C15.4504 11.4631 16.1619 11.7581 16.6975 12.2929C17.8023 13.3978 17.8023 15.1956 16.6975 16.3004Z" fill="white" fill-opacity="0.8"/>
                                <path d="M18.5248 10.2421V0.496826H13.8271V8.78601C14.1118 8.74201 14.4005 8.71314 14.6941 8.71314C16.1323 8.71314 17.484 9.25764 18.5248 10.2421Z" fill="white" fill-opacity="0.8"/>
                                <path d="M10.7458 10.3486C11.0242 10.0702 11.3281 9.82751 11.6498 9.61713V4.73657H6.95215V20.3538H11.6498V18.9768C11.3274 18.7664 11.0235 18.523 10.7458 18.2453C8.56846 16.0679 8.56846 12.5259 10.7458 10.3486Z" fill="white" fill-opacity="0.8"/>
                                </g>
                                <defs>
                    ...
                    <li class="nav-item <?php
                        ...
                        <!-- <li class="nav-item <?php
                            ...
                            <a href="<?= base_url('post-generator'); ?>" class="nav-link hover-shadow" id="letswork">
                                <svg width="14" height="24" viewBox="0 0 16 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item <?php
                                            ...
                                            ?>">
                            <a href="<?= base_url('business-list'); ?>" class="nav-link hover-shadow" id="business-list">
                                
                                <svg width="14" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11 7.47656C13.0646 7.47656 14.7383 5.80288 14.7383 3.73828C14.7383 1.67369 13.0646 0 11 0C8.9354 0 7.26172 1.67369 7.26172 3.73828C7.26172 5.80288 8.9354 7.47656 11 7.47656Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M18.5625 7.47653C19.8677 7.47653 20.9258 6.41846 20.9258 5.11325C20.9258 3.80805 19.8677 2.74997 18.5625 2.74997C17.2573 2.74997 16.1992 3.80805 16.1992 5.11325C16.1992 6.41846 17.2573 7.47653 18.5625 7.47653Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M3.4375 7.47653C4.7427 7.47653 5.80078 6.41846 5.80078 5.11325C5.80078 3.80805 4.7427 2.74997 3.4375 2.74997C2.1323 2.74997 1.07422 3.80805 1.07422 5.11325C1.07422 6.41846 2.1323 7.47653 3.4375 7.47653Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M5.76598 9.59878C4.8357 8.8366 3.99321 8.9375 2.91758 8.9375C1.30883 8.9375 0 10.2386 0 11.8375V16.5301C0 17.2245 0.566758 17.7891 1.26371 17.7891C4.27264 17.7891 3.91016 17.8435 3.91016 17.6593C3.91016 14.3341 3.5163 11.8956 5.76598 9.59878Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M12.0231 8.95463C10.1443 8.79793 8.51129 8.95644 7.10273 10.1191C4.7456 12.0071 5.19922 14.5493 5.19922 17.6592C5.19922 18.482 5.86867 19.164 6.70398 19.164C15.7739 19.164 16.1349 19.4566 16.6727 18.2655C16.8491 17.8627 16.8008 17.9907 16.8008 14.1375C16.8008 11.077 14.1508 8.95463 12.0231 8.95463Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M19.0828 8.93742C18.0013 8.93742 17.1634 8.83756 16.2344 9.59871C18.4672 11.8785 18.0902 14.1506 18.0902 17.6592C18.0902 17.8446 17.7893 17.789 20.6915 17.789C21.4134 17.789 22.0004 17.2042 22.0004 16.4853V11.8374C22.0004 10.2385 20.6915 8.93742 19.0828 8.93742Z" fill="white" fill-opacity="0.8"/>
                                </svg>
                        ...
                        <li class="nav-item <?php
                                            ...
                                            ?>">
                            <a href="<?= base_url('competitor-spy'); ?>" class="nav-link hover-shadow" id="competitor-spy">
                                <svg width="14" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_29_2205)">
                                    <path d="M13.8071 8.88281H8.19238V21.9999H13.8071V8.88281Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M19.8324 11.3471C20.3186 10.8561 20.6196 10.1813 20.6196 9.4373C20.6196 7.93989 19.4013 6.72168 17.904 6.72168C16.4065 6.72168 15.1884 7.93993 15.1884 9.4373C15.1884 10.1813 15.4893 10.8561 15.9755 11.3471C15.6548 11.519 15.3594 11.7324 15.0967 11.98V14.3156H21.949C21.7448 13.0296 20.9405 11.9409 19.8324 11.3471Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M15.0967 15.6047V22.0001H21.3558C21.7118 22.0001 22.0003 21.7116 22.0003 21.3556V15.6047H15.0967Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M4.3869e-05 17.1687V21.3554C4.3869e-05 21.7114 0.288622 22 0.644575 22H6.9037V17.1687H4.3869e-05Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M6.02527 12.9111C6.51151 12.4201 6.81246 11.7453 6.81246 11.0013C6.81246 9.50385 5.59421 8.28564 4.09684 8.28564C2.59946 8.28564 1.38125 9.5039 1.38125 11.0013C1.38125 11.7453 1.68216 12.4201 2.1684 12.9111C1.06032 13.5049 0.255988 14.5936 0.0517578 15.8797H6.90416V13.5441C6.6414 13.2964 6.34608 13.083 6.02527 12.9111Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M12.9284 4.62541C13.4147 4.13445 13.7156 3.45959 13.7156 2.71563C13.7156 1.21821 12.4974 0 11 0C9.50262 0 8.28437 1.21825 8.28437 2.71563C8.28437 3.45959 8.58528 4.1345 9.07156 4.62541C7.96353 5.2192 7.15911 6.30794 6.95492 7.594H15.0451C14.8409 6.30798 14.0365 5.21924 12.9284 4.62541Z" fill="white" fill-opacity="0.8"/>
                                    </g>
                                    <defs>
                       ...
                       <!-- <?php if (($this->session->userdata('logged_in')['id'] == $this->session->userdata('logged_in')['owner_id']) || in_array('youtube_publisher', $team_privileges)) :?>
                        ...
                        <li class="nav-item has-dropdown sidebar-custom-dropdown-parent d-none  <?php
                            ...
                            <a href="javascript:void(0);" class="nav-link hover-shadow dropdown-toggle" id="letswork">
                                <svg width="14" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M0.738281 5.41324V18.5633C0.738281 21.1452 2.83131 23.2383 5.41324 23.2383H18.5633C21.1452 23.2383 23.2383 21.1452 23.2383 18.5633V5.41324C23.2383 2.83131 21.1452 0.738281 18.5633 0.738281H5.41324C2.83131 0.738281 0.738281 2.83131 0.738281 5.41324ZM14.3716 18.3634C8.82202 20.2782 3.69841 15.1545 5.61319 9.60493C6.25836 7.73451 7.73438 6.25836 9.6048 5.61319C15.1545 3.69841 20.2782 8.82202 18.3634 14.3718C17.7182 16.2422 16.2422 17.7182 14.3716 18.3634ZM19.7956 5.18472C19.7073 5.64711 19.3247 5.91614 18.9289 5.91614C18.688 5.91614 18.4425 5.81671 18.2545 5.60097C18.2379 5.58188 18.2223 5.56142 18.2086 5.54013C18.0146 5.2435 18.0085 4.89111 18.1734 4.60533C18.2902 4.40305 18.4786 4.25858 18.7042 4.19815C18.9296 4.13745 19.1652 4.16862 19.3672 4.28549C19.6532 4.45029 19.824 4.75859 19.8045 5.11208C19.8031 5.13625 19.8002 5.16083 19.7956 5.18472Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M11.9875 6.52246C8.97336 6.52246 6.52148 8.97433 6.52148 11.9884C6.52148 15.0025 8.97336 17.4544 11.9875 17.4544C15.0016 17.4544 17.4534 15.0025 17.4534 11.9884C17.4534 8.97433 15.0016 6.52246 11.9875 6.52246Z" fill="white" fill-opacity="0.8"/>
                                    </g>
                                    <defs>
                            ...
                            <ul class="dropdown-menu sidebar-custom-dropdown">
                                ...
                                <?php else : ?>
                                        <li>
                                        <a href="#?>" onclick="show_msg('You do not have permission to access Auto Reply.')" class="dropdown-item <?php
                                            if ($currentpage == "youtube-v2-list") {
                                                echo "active";
                                            }
                                        ?>">
                                ...
                                <?php else : ?>
                                        <li>
                                        <a href="#?>" onclick="show_msg('You do not have permission to access Auto Comment.')" class="dropdown-item <?php
                                            if ($currentpage == "youtube-v2-list") {
                                                echo "active";
                                            }
                                        ?>">
                        ...
                        <li class="nav-item <?php
                            ...
                            <a href="<?= base_url('automation'); ?>" class="nav-link hover-shadow" id="dashboard">
                                <svg width="14" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.1247 8.02075H6.87467C5.98872 8.02075 5.27051 8.73896 5.27051 9.62492V12.3749C5.27051 13.2609 5.98872 13.9791 6.87467 13.9791H15.1247C16.0106 13.9791 16.7288 13.2609 16.7288 12.3749V9.62492C16.7288 8.73896 16.0106 8.02075 15.1247 8.02075Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M15.1247 1.14575H6.87467C5.98872 1.14575 5.27051 1.86396 5.27051 2.74992V5.49992C5.27051 6.38588 5.98872 7.10409 6.87467 7.10409H15.1247C16.0106 7.10409 16.7288 6.38588 16.7288 5.49992V2.74992C16.7288 1.86396 16.0106 1.14575 15.1247 1.14575Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M15.1247 14.8958H6.87467C5.98872 14.8958 5.27051 15.614 5.27051 16.4999V19.2499C5.27051 20.1359 5.98872 20.8541 6.87467 20.8541H15.1247C16.0106 20.8541 16.7288 20.1359 16.7288 19.2499V16.4999C16.7288 15.614 16.0106 14.8958 15.1247 14.8958Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M1.83365 6.18741C1.65948 6.18741 1.48531 6.12324 1.34781 5.98574C1.08198 5.71991 1.08198 5.27991 1.34781 5.01407L2.23698 4.12491L1.34781 3.23574C1.08198 2.96991 1.08198 2.52991 1.34781 2.26407C1.61365 1.99824 2.05365 1.99824 2.31948 2.26407L3.69448 3.63907C3.96031 3.90491 3.96031 4.34491 3.69448 4.61074L2.31948 5.98574C2.18198 6.12324 2.00781 6.18741 1.83365 6.18741Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M18.7917 19.9375C18.6175 19.9375 18.4433 19.8734 18.3058 19.7359C18.04 19.47 18.04 19.03 18.3058 18.7642L19.195 17.875L18.3058 16.9859C18.04 16.72 18.04 16.28 18.3058 16.0142C18.5717 15.7484 19.0117 15.7484 19.2775 16.0142L20.6525 17.3892C20.9183 17.655 20.9183 18.095 20.6525 18.3609L19.2775 19.7359C19.14 19.8734 18.9658 19.9375 18.7917 19.9375Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M18.3333 11.6875H17.875C17.4992 11.6875 17.1875 11.3758 17.1875 11C17.1875 10.6242 17.4992 10.3125 17.875 10.3125H18.3333C18.9658 10.3125 19.4792 9.79917 19.4792 9.16667V5.95833C19.4792 5.32583 18.9658 4.8125 18.3333 4.8125H17.875C17.4992 4.8125 17.1875 4.50083 17.1875 4.125C17.1875 3.74917 17.4992 3.4375 17.875 3.4375H18.3333C19.7267 3.4375 20.8542 4.565 20.8542 5.95833V9.16667C20.8542 10.56 19.7267 11.6875 18.3333 11.6875Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M4.12467 18.5625H3.66634C2.27301 18.5625 1.14551 17.435 1.14551 16.0417V12.8333C1.14551 11.44 2.27301 10.3125 3.66634 10.3125H4.12467C4.50051 10.3125 4.81217 10.6242 4.81217 11C4.81217 11.3758 4.50051 11.6875 4.12467 11.6875H3.66634C3.03384 11.6875 2.52051 12.2008 2.52051 12.8333V16.0417C2.52051 16.6742 3.03384 17.1875 3.66634 17.1875H4.12467C4.50051 17.1875 4.81217 17.4992 4.81217 17.875C4.81217 18.2508 4.50051 18.5625 4.12467 18.5625Z" fill="white" fill-opacity="0.8"/>
                                </svg>
                                <span class="menu-title">Automation</span>
                            </a>
                        </li>
                        ...
                        <!-- <li class="nav-item <?php
                                if ( $currentpage == "generate-hastag") {
                                    echo "active";
                                }
                                ?>">
                            <a href="<?= base_url('generate-hastag'); ?>" class="nav-link hover-shadow" id="letswork">
                                <svg width="14" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.3639 23.9917C4.94201 23.3139 0.682773 19.0547 0.00565545 13.6342C-0.047415 13.2154 0.279775 12.8438 0.703401 12.8438H3.54586C3.88922 12.8438 4.18177 13.0917 4.23948 13.4295C4.78612 16.6669 7.32915 19.2106 10.5686 19.7579C10.9064 19.8156 11.1543 20.1082 11.1543 20.4515V23.294C11.1543 23.7122 10.7917 24.0427 10.3639 23.9917Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M3.54585 11.2517H0.703396C0.279535 11.2517 -0.0473735 10.8798 0.00565012 10.4613C0.75009 4.49749 5.84579 0 11.8576 0C14.5283 0 17.0604 0.870787 19.1804 2.51832C19.5175 2.78137 19.5428 3.27462 19.2463 3.5711L17.2369 5.58121C16.9937 5.825 16.6119 5.85524 16.3317 5.65674C15.0125 4.71657 13.4652 4.21938 11.8575 4.21938C8.07424 4.21938 4.86985 6.93067 4.23943 10.6659C4.18176 11.0037 3.88922 11.2517 3.54585 11.2517Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M12.75 23.2952V20.4527C12.75 20.1094 12.9979 19.8168 13.3358 19.7591C17.071 19.1287 19.7823 15.9243 19.7823 12.141C19.7823 10.5333 19.2851 8.98607 18.345 7.66681C18.1458 7.3873 18.1774 7.00408 18.4205 6.76166L20.4306 4.75224C20.7233 4.45956 21.2181 4.47813 21.4834 4.81816C23.1309 6.93817 24.0017 9.47022 24.0017 12.1409C24.0017 18.1527 19.5042 23.2484 13.5404 23.9929C13.1079 24.0444 12.75 23.7085 12.75 23.2952Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M9.18402 9.18761C9.18402 8.79923 8.86916 8.48438 8.48079 8.48438H7.07432C6.68595 8.48438 6.37109 8.79923 6.37109 9.18761V14.8135C6.37109 15.2018 6.68595 15.5167 7.07432 15.5167H8.48079C8.86916 15.5167 9.18402 15.2018 9.18402 14.8135V9.18761Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M13.4028 14.8137V7.78136C13.4028 7.39298 13.0879 7.07812 12.6995 7.07812H11.2931C10.9047 7.07812 10.5898 7.39298 10.5898 7.78136V14.8137C10.5898 15.202 10.9047 15.5169 11.2931 15.5169H12.6995C13.088 15.5169 13.4028 15.202 13.4028 14.8137Z" fill="white" fill-opacity="0.8"/>
                                    <path d="M17.6254 14.813V12.0001C17.6254 11.6117 17.3106 11.2969 16.9222 11.2969H15.5157C15.1274 11.2969 14.8125 11.6117 14.8125 12.0001V14.813C14.8125 15.2014 15.1274 15.5163 15.5157 15.5163H16.9222C17.3106 15.5163 17.6254 15.2014 17.6254 14.813Z" fill="white" fill-opacity="0.8"/>
                                </svg>
                                <span class="menu-title">Trend Analysis</span>
                            </a>
                        </li> -->
                        ...
                        <!-- <?php if (($this->session->userdata('logged_in')['id'] == $this->session->userdata('logged_in')['owner_id']) || in_array('ai_tubeagent', $team_privileges)) :?>
                            <li class="nav-item <?php if ($currentpage == "virtual-assistant" || $currentpage == "conversation") { echo "active"; } ?>">
                    ...
                    <li class="profile style-2" style="padding: 10px;">
                        <a class="dropdown-toggle drop-after" data-bs-toggle="dropdown" id="profile">
                            <span class="profile-pic"><img src="<?= ($this->session->userdata('logged_in')['profile_pic'] == '' || $this->session->userdata('logged_in')['profile_pic'] == "default_profile.png") ? $assetsPath . 'default/images/default_profile.png' : $this->config->item('bucket_url') . $this->session->userdata('logged_in')['profile_pic']  ?>" class="img-fluid"></span>
                            <div>
                                <div class="user-name"><?php echo  !empty($this->session->userdata('logged_in')['name']) ?  $this->session->userdata('logged_in')['name'] : John  ?></div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end animated--grow-in" aria-labelledby="dropdownMenuButton1">
                        ...
                        <?php if (($this->session->userdata('logged_in')['id'] == $this->session->userdata('logged_in')['owner_id']) || in_array('my_profile', $team_privileges)) {?>
                            <li><a class="dropdown-item" href="<?= base_url('profile'); ?>"><i class="icon-user"></i> My Profile</a></li>
                        <?php }else{ ?> 
                            <li><a class="dropdown-item" href="#" onclick="show_msg('You do not have permission to access Profile.')"><i class="icon-user"></i> My Profile</a></li>
                        <?php } ?>   
                            ...
                            <li><a class="dropdown-item" href="<?= base_url('logout'); ?>"><i class="icon-logout"></i> Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <a href="javascript:void(0);" class="nav-down-arrow" title="Scroll Down"><i class="fa-solid fa-arrow-down"></i></a>
        </div>
    </div>
    <!-- Sidebar Start End -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('create-workspace'); ?>" method="post" enctype="multipart/form-data">
                        <div class="row  d-flex justify-content-around">
                            <div class="col-md-3 mt-md-3 mt-0">
                                <div class="inline-flex">
                                </div>
                                <div class="profile-img profile-text">
                                    <img src="<?php echo $this->config->item('assetsPath') ?>uploads/default_images/default_business_logo.png" class="" id="imageShow" />
                                    <label for="profile_upload" class="profile-text d-none"><i class="icon-list-edit"></i></label>
                                    <input id="profile_upload" class="d-none" type="file" accept="image/*" name="business_logo" onchange="loadImage(this)">
                                </div>
                                    ...
                                    <div class="col-md-12 mt20">
                                        ...
                                        <div class=" mt25 field-white-bg">
                                            ...
                                            ng-touched form-control search1" maxlength="25"
                                                placeholder="Enter Your Workspace Name (Max : 25 Characters) " type="text" name="domain"
                                                autocomplete="off" required><!-- end ngIf: is_edit_subdomain == '0' -->
                                        </div>
