                                                        ...
                                                        <div class="modal fade upload-modal" id="uploadModal" tabindex="-1">
                                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width: 500px;">
                                                                <div class="modal-content overflow-auto">
                                                                    ...
                                                                    <form action="<?php echo base_url('upload-avatar')?>"  method="POST"  enctype="multipart/form-data">
                                            ...
                                            <div class="inner-wrapper">
                                                ...
                                                <div class="list-group">
                                                    ...
                                                    <div class="list-group-item list-group-item-action ">
                                                        <span class="icon"><i class="fa-solid fa-play" onclick="playSample('<?php echo$value->preview_audio ?>',<?php echo $key  ?>)"></i></span>
...
function playSample(audioUrl, index) {
    if (playingIndex === index) {
        ...
        // Reset playing index when audio ends
