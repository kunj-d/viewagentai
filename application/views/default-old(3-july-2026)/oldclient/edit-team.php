                            ...
                            <div class=" col-xs-12">
                                ...
                                <div class="whitesection add-member">
                                    ...
                                    <div class="row mb20 align-items-center">
                                        ...
                                        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 mb20">
                                            ...
                                            <input type="text" placeholder="Enter Your Client Name" class="form-control search1" name="name" id="name" value="<?php echo $team_data['name']?>">
                                    ...
                                    <div class="row mb20 align-items-center">
                                        ...
                                        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 mb20">
                                            ...
                                            <input type="text" placeholder="Enter Your Client Email" class="form-control search1" name="email" id="email" value="<?php echo $team_data['email']?>" readonly style="background:transparent;">
                                ...
                                <div class="row mb20 align-items-center">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 mb20">
                                        ...
                                        <label class="text-dark">Add More Issue AI Credits to your client</label> 

                                    </div>

                                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 mb20">

                                        <input type="number" placeholder="Enter Issue AI Credits to your client" class="form-control search1" name="image_balance_2" id="image_balance_2">
                                ...
                                <div class="row mb20 align-items-center">
                                        ...
                                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 mb20">
                                            ...
                                            <label class="text-dark">Available Copilot Training Data Size (in Kb)</label> 
                                 ...
                                 <div class="row mb20 align-items-center">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 mb20">
                                        ...
                                        <label class="text-dark">Add More Copilot Training Data Size (in Kb)</label> 

                                    </div>

                                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 mb20">

                                        <input type="number" placeholder="Enter Copilot Training Data Size (in Kb)" class="form-control search1" name="image_balance_3" id="image_balance_3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 d-flex justify-content-center">
                                            ...
                                            <a href="<?= base_url('client-management') ?>" class="btn btn-danger mr10">Cancel</a>

                                            <input type="submit" class="btn btn-primary save-data" value="Save Changes">
