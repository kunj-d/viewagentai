                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <p class="container-page-subtitle">Create & manage all client's here</p>
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-inline-flex gap-2 " style="background: transparent !important;">

                                        <a href="<?php echo base_url() ?>edit-client-member/<?= $conversation['id'] ?>" class="action-btn blue-btn-outline"><i class="icon-list-edit icon-edit"></i></a>
