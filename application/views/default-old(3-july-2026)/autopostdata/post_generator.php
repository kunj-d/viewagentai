...
<style>
    ...
    .header-stripe{
        ...
        top: 0;
        padding: 13px 25px;
        background: linear-gradient(180deg, rgba(252, 102, 72, 0.35) -3.14%, rgba(219, 60, 59, 0.5) 113.36%);
        z-index: 1;
...
<div class="container-wrapper container-open" ng-app="AppModule" ng-controller="PostController">
    <div class="container-fluid container-padding p-0">
        <div class="header-stripe" ng-show="isChatActive">
            <div class="logo"><img src="<?php echo $this->config->item('assetsPath') ?>images/stripe-logo.png" alt="logo"></div>
            <div>
                <svg width="40" height="8" viewBox="0 0 40 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="4" cy="4" r="4" fill="#FFA33B"/>
                    <circle cx="20" cy="4" r="4" fill="#00BF29"/>
                    <circle cx="36" cy="4" r="4" fill="#F64B4D"/>
                </svg>
            </div>
        </div>
                ...
                <div class="col-12 h-100">
                    <div class="ai-command-inner">
                        <div class="ai-command-header mt-auto">
                            ...
                            <h2 class="ai-command-title" data-text="Tell your AI">
                                Tell Your AI Agents What You Want To Create.
                            </h2>

                            <p class="ai-command-description">
                                Type Or Speak Your Command To Get Started.
                            </p>
                        </div>
                                    ...
                                    <div class="chat-message chat-message-left" ng-if="msg.subType == 'video'">
                                        ...
                                        <div class="chat-card">
                                            <div class="chat-content">
                                                ...
                                                <a href="<?php echo base_url('automation');?>" class="btn btn-primary">
                                                    <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M15.2006 11.8311H4.50149C4.06053 11.8311 3.70312 11.4737 3.70312 11.0327C3.70312 10.5918 4.06053 10.2344 4.50149 10.2344H15.2004C15.6413 10.2344 15.9987 10.5918 15.9987 11.0327C15.9987 11.4737 15.6416 11.8311 15.2006 11.8311Z" fill="white"/>
                                                        <path d="M15.2006 6.82329H4.50149C4.06053 6.82329 3.70312 6.46589 3.70312 6.02493C3.70312 5.58396 4.06053 5.22656 4.50149 5.22656H15.2004C15.6413 5.22656 15.9987 5.58396 15.9987 6.02493C15.999 6.46589 15.6416 6.82329 15.2006 6.82329Z" fill="white"/>
                                                        <path d="M15.2006 1.80766H4.50149C4.06053 1.80766 3.70312 1.45026 3.70312 1.0093C3.70312 0.568338 4.06053 0.210938 4.50149 0.210938H15.2004C15.6413 0.210938 15.9987 0.568338 15.9987 1.0093C15.9987 1.45026 15.6416 1.80766 15.2006 1.80766Z" fill="white"/>
                        ...
                        <div class="ai-command-box">
                            ...
                            <textarea ng-keydown="checkEnter($event)" class="ai-command-input" placeholder=" Example: 'Hey Social Agent, post viral reels on Instagram & YouTube tomorrow about ‘Stoic Wisdom’ at 10 AM...' " ng-model="commandText"></textarea>

                            <button class="ai-command-button" ng-click="generatePost()">
                                <span>Process Command</span> <i class="fa-solid fa-arrow-right"></i>
                            </button>

                        </div>
                        <!-- Social Status -->
                        <div class="ai-social-wrapper mt-auto">
...
<script>
    ...
    $scope.generatePost = function(){
        ...
        if (!$scope.commandText) {
            flashNow({
                error: { message: "Please Enter prompt." }
            });
            return;
        }
    
        $scope.isChatActive = true;
        $scope.lastUserPrompt = $scope.commandText;
        // ✅ USER MESSAGE ADD
        $scope.messages.push({
            type: 'user',
            text: $scope.commandText
        });
    ...
    //         if ($scope.commandText == "") {
    //                 flashNow({
    //                     error: { message: "Please Enter propmt." }
    //                 });
    //                 return
    //         }
    //         $scope.isChatActive = true;
