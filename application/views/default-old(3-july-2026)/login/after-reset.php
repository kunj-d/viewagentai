                            ...
                            <div class="login-form d-inline-block">
                                <form action="">
                                    <div class="text-center">
                                        <div class="form-icon">
                                            <img src="<?= $this->config->item('assetsPath') ?>images/right-icon.png" alt="" class="img-fluid mx-auto d-block">
                                        </div>
                                        <h5 class="headingsub-heading-border my-3">Your password has been successfully reset.</h5>
                                    </div>
