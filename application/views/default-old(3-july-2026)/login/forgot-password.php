                ...
                <div class="row m-0 h-100 align-items-center justify-content-center">
                    <div class="col-lg-6 text-center h-100 d-flex align-items-center justify-content-center flex-column position-relative overflow-hidden z-1">
                        <div class="auth-section">
                            ...
                            <div class="sub-heading sub-heading-border">Enter your email and we'll send you a link to <br> get back into your account.</div>
                                ...
                                <form action="<?= base_url('forgot-password'); ?>" method="post" class="form_ajax">
                                    <div class="form-item text-start">
                                        ...
                                        <div class="form-item-in">
                                            ...
                                            <input type="email" id="username"  class="form-control" placeholder="Enter Your Email" value="" name="email" autocomplete="off" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    <div class="form-footer btn-wrapper-login">
                                        <button type="submit" name="login" class="signbtn btn-block">Send Reset Link </button>
                                    </div>
