                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-description" role="tabpanel"
                                ...
                                <div class="opt-section">
                                    ...
                                    <div class="form-group mb-3 pt-2 pb-3 px-3 border radius-3 bg-light">
                ...
                <div class="card gap-4 p-4">
                    <div class="card-head">
                        ...
                        <i class="fa-solid fa-circle-info ms-2 info-tooltip"
                            ...
                            data-bs-title="AEO score checks how well your title, description, and tags are optimized."
                        >
                        </i>
                    </div>
                    <div class="row">
...
$scope.videoOwnershipVerified = false;
            ...
            if (dataInput && form) {
                ...
                form.submit();
                toastr.success("Preparing report with selected title & score...");
            } else {
