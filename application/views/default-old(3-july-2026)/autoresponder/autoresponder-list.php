...
<div class="container-wrapper container-open" ng-app="AppModule" ng-controller="autoresponderListCtrl" ng-cloak>
        <title><?php echo $this->config->item('productName') ?> | Leads List</title>
        ...
        <div class="row align-items-center">
            <div class="col-12">
                ...
                <p class="container-page-subtitle mt10">Checkout all Leads Generated using Copilot.</p>
            </div>
        </div>
                    ...
                    <table id="data-table" class="table table-striped" style="width:100%; margin-top:30px !important;">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td><a href="#" class="action-btn red-btn-outline delete-lead" data-id="<?php echo $val['id'] ?>"> <i class="icon-list-delete"></i></a></td>
