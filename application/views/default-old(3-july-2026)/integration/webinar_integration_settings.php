<div class="tab-pane fade <?php echo $active_tab=="webinar"? 'in active show':'' ;?>" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
    <?php   
    if(in_array('webinar_integration',$this->session->userdata('features')) ) {
    ?>
    <div class="row">
       <?php if($all_webinar){
        foreach ($all_webinar as $key => $profile) {
            ...
            <div class="col-12 col-md-4 mt-4">
                <div class="tab-box">
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="active_tab" value="webinar" />
