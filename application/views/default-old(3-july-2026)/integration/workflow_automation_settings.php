<div class="tab-pane fade <?php echo $active_tab=="workflow"? 'in active show':'' ;?>" id="pills-workflow" role="tabpanel" aria-labelledby="pills-workflow-tab">
    <?php   
    if(in_array('Pabbly_intigration',$this->session->userdata('features')) ) {
    ?>
    <div class="row">
       <?php if($all_workflow){
        foreach ($all_workflow as $key => $profile) {
