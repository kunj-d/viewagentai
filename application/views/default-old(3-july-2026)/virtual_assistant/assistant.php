                        ...
                        <div class="row align-items-center justify-content-between g-0">
                            <div class="col-auto feature-wrap">
                                ...
                                <p class="feature-subtitle mb-0">
                                    Choose your AI Agent and chat with an expert
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="tabs-banner">
                        <ul class="f-12 w600 white p-0 m-0 tabs-list"  onclick="tabActive(event)">
                            ...
                            <li class="active" ng-click="changeTab(14)">AI Growth Agent</li>
                            <li ng-click="changeTab(12)">Instagram</li>
                            <li ng-click="changeTab(13)">Facebook</li>
                            <li ng-click="changeTab(11)">YouTube</li>
                        </ul>
                    </div>
                </div>
            </div>
