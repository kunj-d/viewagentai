...
<div class="container-wrapper container-open" ng-app="AppModule" ng-controller="visController" ng-cloak>
            ...
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center align-items-center avatar-main-tabs">
                    <ul class="nav nav-pills nav-pills-style-4 mb-0 justify-content-center" id="pills-tab" role="tablist">
                        ...
                        <!--<li class="nav-item pointer" role="presentation">-->
                        <!--    <button class="nav-link" id="pills-voice-tab" data-bs-toggle="pill" data-bs-target="#pills-voice" type="button" role="tab" aria-controls="pills-voice" aria-selected="false" style="transition: 0.2s">-->
                        <!--        <i class="fa-solid fa-thumbs-up"></i>-->
                        <!--        Finalize Video-->
                        <!--    </button>-->
                        <!--</li>-->
                        <li class="nav-item pointer" role="presentation">
    <button class="nav-link disabled" id="pills-voice-tab"  data-bs-toggle="pill"  data-bs-target="#pills-voice"  type="button"  role="tab"  aria-controls="pills-voice"  aria-selected="false"  disabled>
        <i class="fa-solid fa-thumbs-up"></i>
        Finalize Video
    </button>
</li>
                                    ...
                                    <div class="col-12">
                                        <div class="theme-card">
                                            <div class="row gap-0 g-3">
                                                    ...
                                                    <div id="ideaContainer" class="theme-bg-dark p-3 border radius-3 custom-scroll" style="height: 550px; scrollbar-width: none;">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="theme-card theme-card-style-2">
                                                                ...
                                                                <label class="form-label" for="avatar_name">  Name <span class="text-danger">*</span></label>
                                                                ...
                                                                <input type="text"   class="form-control"  ng-model="avatar_name"  id="avatar_name"  name="name"   placeholder="Enter Your Avatar Name"  autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <h6 class="title title-design">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="theme-bg-dark radius-3">
                                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                                            <h6 class="title title-design mb-0">
                                                                <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#clip0_333_2238)">
                                                                    <path d="M10.4867 9.53438H5.51172C2.96484 9.53438 0.902344 11.5969 0.902344 14.1438C0.902344 15.1688 1.73359 16 2.75859 16H13.2398C14.2648 16 15.0961 15.1688 15.0961 14.1438C15.0961 11.5969 13.0336 9.53438 10.4867 9.53438Z" fill="#DB1A1A"></path>
                                                                    <path d="M8 8.21875C10.2695 8.21875 12.1094 6.37892 12.1094 4.10938C12.1094 1.83983 10.2695 0 8 0C5.73045 0 3.89062 1.83983 3.89062 4.10938C3.89062 6.37892 5.73045 8.21875 8 8.21875Z" fill="#DB1A1A"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="clip0_333_2238">
                                                                    <rect width="16" height="16" fill="white"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>Avatar Name
                                                            </h6>
                                                            <button class="btn btn-primary px-3 d-none" data-bs-toggle="modal" data-bs-target="#talkingavatarModal"> 
                                                                <i class="fa-solid fa-wand-magic-sparkles"></i>AI Generate  
                                                            </button>
                                                        </div>        
                                                        <div class="theme-card theme-card-style-2" style="background: var(--bg-dark);">
                                                            <input type="text" class="form-control" ng-model="avatar_name" id="avatar_name" placeholder="Enter Your Avatar Name" autocomplete="off">
                                                        </div>
                                                        <div class="mt-4 mb-3">
                                                            <h6 class="title title-design mb-0">
                                                        ...
                                                        <div class="theme-card theme-card-style-2" style="background: var(--bg-dark);">
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <div class="prompt-box position-relative">
                                                                    <textarea name="custom_prompt" id="custom_prompt" rows="5" class="form-control" ng-model="customprompt" placeholder="E.g. Hi there! Welcome to our channel..." maxlength="500"></textarea>
                            ...
                            <div class="tab-pane fade" id="pills-voice" role="tabpanel" aria-labelledby="pills-voice-tab" tabindex="0">
                                <div class="row g-xl-5 g-4 justify-content-center">
                                    <div class="col-lg-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="tab-content">
                                                            <div class="tab-pane fade show active" id="pills-all-avatars" role="tabpanel" aria-labelledby="pills-all-avatars-tab" tabindex="0">
                                                                <div class="row row-cols-2 row-cols-md-4 row-cols-sm-3 gap-0 g-3 custom-scroll" style="height: 400px;">
                                                                    <div class="col-sm-6 col-md-4 <?= $_GET['avatar_type'] ? 'd-none' : '' ?>">
                                                                    ...
                                                                    <div class="col-sm-6 col-md-4" ng-repeat="avatar in avatarImages">
                                                            ...
                                                            <div class="tab-pane fade" id="pills-my-avatar" role="tabpanel" aria-labelledby="pills-my-avatar-tab" tabindex="0">
                                                                <div class="row row-cols-2 row-cols-md-4 row-cols-sm-3 gap-0 g-3 custom-scroll" style="height: 300px;">
                                                                    <div class="col-sm-6 col-md-4 myagents-class" ng-repeat="avatar in avatarImages | filter: filterAvatars" data-myagents-count="{{ (avatarImages | filter: filterAvatars).length }}">
                                                            ...
                                                            <div class="tab-pane fade" id="pills-ai-avatar" role="tabpanel" aria-labelledby="pills-ai-avatar-tab" tabindex="0">
                                                                <div class="row row-cols-2 row-cols-md-4 row-cols-sm-3 gap-0 g-3 custom-scroll" style="height: 300px;">
                                                                    <div class="col-sm-6 col-md-4" ng-repeat="avatar in avatarImages | filter : filterDefaultAvatars">
                                                                        <div class="avatar-wrapper avatar-wrapper-style-2" ng-class="{'active': activeAvatarId === avatar.id}"  ng-click="activeAvatar(avatar.id,avatar.url,avatar.video_url,avatar.name)">
                                                                            <div class="avatar-wrapper-inner gap-0">
                                                                                <div class="avatar-img" style="overflow: visible;">
                                                                                    <div class="check-icon" style="border-radius: inherit;">
                                        ...
                                        <div class="voice-wrapper d-none">
                                            <div class="voice-area">
                                                <div class="d-flex align-items-center justify-content-between mb-3">
                                                    <p class="mb-0">Select Voice</p>     
                                                    <ul class="nav nav-pills nav-pills-style-2" id="pills-tab" role="tablist">
    ...
    <div class="modal fade modal-talkingavatar" id="talkingavatarModal" tabindex="-1" aria-labelledby="talkingavatarModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title title-design fs-5 mb-0" id="talkingavatarModalTitle">
                    Create Your AI Avatar Video
                </h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div id="ideaContainer" class="theme-bg-dark radius-3 custom-scroll" style="height: 330px; scrollbar-width: none;">
                    <div class="mb-3" ng-hide="showIdeaList">
                        <div class="theme-card theme-card-style-2">
                    ...
                    <div ng-show="showIdeaList">
                        <div class="theme-card theme-card-style-2">
                            ...
                            <div class="row gap-0 g-3">
                            <button class="btn btn-primary" ng-click="generateidea()"><i class="fa-solid fa-arrows-rotate"></i> Regenerate</button>
                                <div class="col-md-6" ng-repeat="idea in videoIdeas track by $index">
                                    <label class="idea-card">
                                       
                                        <input type="radio" name="idea" ng-value="idea" ng-model="selectedIdea">
                                        <!--<div class="card-inner" ng-click="generatescript(idea)">-->
                                        <div class="card-inner" ng-click="generatescript(idea); $('.modal').modal('hide')">
                                            <div class="top">
                                                <span class="idea-tag">Idea 0{{$index+1}}</span>
                                                <span class="radio-circle"></span>
                                            </div>
                            ...
                            <div class="row g-0 gap-0">
                                <div class="col-md-8">
                                    <div class="left-area">
                                        <div class="border-bottom pb-4 mb-4">
                                            <label class="form-label" for="avatar_name">Name</label>
                                            <input type="text" class="form-control ng-pristine ng-valid ng-touched" ng-model="avatar_name" id="avatar_name" placeholder="Enter Your Avatar Name" autocomplete="off">  
                                        </div>
                                        <div class="form-group custom-file-upload custom-file-upload-style-2 upload_img_change h-100 flex-column text-center justify-content-center">
                                            <div class="left">
                                                <div class="image-box">
                                        ...
                                        <div class="d-flex align-items-center justify-content-end gap-2 mt-auto">
                                            <button type="button" class="btn btn-outline btn-outline-white" data-bs-dismiss="modal">Cancel</button>
                                            <button type="submit" class="btn btn-primary" >Upload</button>
                                            <!--<button type="submit"   class="btn btn-primary"   ng-disabled="!avatar_name || avatar_name.trim() == ''">  Upload</button>-->
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
     ...
     $scope.generate = function () {
        ...
        $("body").append(`
            <div class="temp_js_loader" style="background: rgba(0, 0, 0, 0.34); width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 9999;">
                ...
                <div style="position: absolute; top: 68%; left: 50%; transform: translate(-50%, -50%); color: black; font-size: 16px; text-align: center;">
...
var avatar_name = $('#avatar_name').val().trim();
