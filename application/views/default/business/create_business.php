                 ...
                 <form method="post" action="" enctype="multipart/form-data" id="business_form">
                    ...
                    <div class="row  justify-content-center">
                        ...
                        <div class="col-12 mt-2 text-center text-md-center">
                            ...
                            <!-- <a href="https://support.oppyo.com/support/solutions/1120000061278" target="_blank" class="btn btn-primary"> -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                                <i class="fa-solid fa-video"></i> Watch Trainings
                            </button>
                        </div>
                        <div class="col-12 mt30">
                            <a href="<?php echo base_url('training') ?>" target="_blank" class="text-dark text-center d-block"
                            style="
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <div>
                            <h1 class="modal-title title-line" id="exampleModalCenterTitle">How to Create Workspace</h1>
                            <!-- <p class="desc mb-0">Set up a dedicated area to manage projects and team.</p> -->
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="video-demo mt-0">
                            <iframe src="https://tube-claw-ai.dotcompal.co/video/embed/ad461hv9h9" data-videosrc="https://tube-claw-ai.dotcompal.co/video/embed/ad461hv9h9" frameborder="0" allow="autoplay; fullscreen" allowfullscreen=""></iframe>
                        </div>
                    </div>
