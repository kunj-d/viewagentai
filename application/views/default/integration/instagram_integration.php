...
<div class="tab-pane fade <?php echo $active_tab=="insta"? 'in active show':'' ;?>" id="pills-insta" role="tabpanel" aria-labelledby="pills-insta-tab">
                ...
                <div class="col-xs-12 padding0">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-8 col-xs-12 d-flex align-items-center gap-2">
                            ...
                            <button type="button" class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#instaModalCenter"> Integration Tutorial </button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="modal fade modal-watch-training" id="instaModalCenter" tabindex="-1" aria-labelledby="instaModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <div>
                            <h1 class="modal-title title-line" id="instaModalCenterTitle">Instagram Integration Process</h1>
                            <p class="desc mb-0">Link your Instagram account for automated publishing and content management.</p>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="video-demo mt-0">
                            <iframe src="https://tube-claw-ai.dotcompal.co/video/embed/d6utw3unqo" data-videosrc="https://tube-claw-ai.dotcompal.co/video/embed/d6utw3unqo" frameborder="0" allow="autoplay; fullscreen" allowfullscreen=""></iframe>
                        </div>
                    </div>
...
//     const modal = document.getElementById("instaModalCenter");
...
//  $('#instaModalCenter').on('hidden.bs.modal', function () {
