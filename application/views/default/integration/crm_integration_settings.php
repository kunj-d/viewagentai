<div class="tab-pane fade <?php echo $active_tab=="crm"? 'in active show':'' ;?>" id="crm" role="tabpanel" aria-labelledby="crm">
    <?php   
    if(in_array('crm_integration',$this->session->userdata('features')) ) {
    ?>
    <div class="row">
        <?php if($all_crm){
        foreach ($all_crm as $key => $profile) {
