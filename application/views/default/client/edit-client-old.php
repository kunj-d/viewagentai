...
<title><?php echo $this->config->item('productName') ?> | Edit Client</title>
                ...
                <div class="feature-banner">
                    <div class="row align-items-center justify-content-between g-0">
                        <div class="col-auto feature-wrap">
                            <h5 class="feature-title">Manage Client</h5>
                            <p class="feature-subtitle mb-0">
                                Edit & Manage Client Details Here
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="whitesection">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" placeholder="Name" class="form-control" name="name" id="name" value="<?php echo $team_data['name']; ?>">
							<span class="form_error form_error_name"></span>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Email <span class="red">*</span></label>
							<input type="text" placeholder="Email" class="form-control" name="email" id="email" disabled value="<?php echo $team_data['email']; ?>">
                        ...
                        <div class="col-12">
                            <div class="usersection">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="selectpicker rolechooser role" name="user_role[]" title="Select User Level" data-dropup-auto="false" data-size="5">
												...
												<?php foreach($role_types as $key=>$user_role) { ?>
													<option value="<?php echo $user_role->id; ?>" <?php if($team_data['role_id'] == $user_role->id){echo 'selected';} ?>>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="selectpicker user_business website" title="Select Workspace" data-dropup-auto="false" data-size="5" name="user_business[]">
												...
												<?php foreach($business_list as $key=>$user_business) { ?>
													<option value="<?php echo $user_business->id; ?>" <?php if($team_data['business_id'] == $user_business->id){echo 'selected';} ?>>
														<?php echo $user_business->domain; ?>
													</option>
												<?php } ?>
											</select>
                                ...
                                <div class="col-12 privileges manager" style="<?php if($team_data['role_id'] != 1){echo 'display: none;';} ?>">
									<div class="row">
										<div class="col-lg-2 col-md-3 col-sm-4 col-12px">
											Privileges:
										</div>
                            ...
                            <div class="text-end">
								<a href="<?=site_url('client-management')?>" class="btn btn-danger buttongap me-1">Cancel</a>
	   ...
	   $('.form_error').html('');
   	 var teamData=[];
   		$(".usersection").each(function(index){ 
   			...
   			userData={user_name: user_name, user_email: user_email,role_type:role_type,business:business,assign_name:assign_name,custom_role:custom_role,privilege:privilege};
   		...
   		$.ajax({
   			dataType:'json',
   			type:"POST",
   			url:"<?php echo base_url('edit-client-json'); ?>",
