...
<div class="container-wrapper container-open"  ng-app="AppModule" ng-controller="conversationCtrl" ng-cloak>
   ...
   <!-- Main Container Start -->
    <div class="container-fluid container-padding">
        <div class="row">
            <div class="col-12 wrapper-box2  chat-main-container">
                ...
                <div class="chat-sidebar-container">
					<div class="chat-sidebar-search">	
						<div class="search-bar ">
                            ...
                            <input type="text" class="search form-control" placeholder="Search.." ng-model="chatSearch">
                          
                        </div>			
					</div>
					<div class="chat-sidebar-messages">						
						<div class="chat-sidebar-message" ng-class="{ 'selected-message': isSelected(list.id) }" ng-repeat="list in chatlist | filter: chatSearch" ng-click="getConversation(list.id)">
							<h6 class="chat-title">
							{{ list.chat_name }}
							</h6>
							<div class="chat-info">
							...
							<div class="chat-actions d-flex">
								<a href="javascript:void(0)" ng-click="editChat(list.id,list.chat_name)" class="chat-edit f-16" data-toggle="tooltip" data-placement="top"  title="Edit Name"><span class="icon-list-edit"></span></a>
								<a href="javascript:void(0)" ng-click="deleleChatModal(list.id);" class="chat-delete f-16 ms-3"  title="Delete Chat"><span class="icon-list-delete"></span></a>
							</div>
						</div>
						<!-- Chat Delete modal -->
					    <div class="modal fade" id="chat_deletion" tabindex="-1" aria-labelledby="chat_deletion" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-body text-center">
                                <i class="fa-solid fa-circle-exclamation text-danger mb-3" style="font-size : 50px"></i>    
                              ...
                              <div class="modal-footer justify-content-center border-0 pt-0">
                                ...
                                <button type="button" ng-click="deleleChat()" class="btn btn-danger">Delete</button>
                              </div>
                            </div>
                          </div>
                        </div>
					...
					<div class="card-footer">
    					<div class="row text-center">						
    						<div class="col-sm-12">									
    							<a class="btn btn-primary pl-6 pr-6 f-14 mt-2" ng-click="newConversation()">New Conversation</a>
    						</div>
    					</div>
    				</div>
				</div>
				...
				<div class="chat-message-container" style='<?php echo $assistantData->assistant_status == "super_va" ? "width: 100%;" : ""; ?><?php echo $assistantData->assistant_status == "super_va" ? "left: unset;" : ""; ?>'>
			      <div class="card-header">
						<div class="w-100 pt-2 pb-2">
							<div class="d-flex">
								<div class="overflow-hidden me-4"><img alt="Avatar" class="chat-avatar" src="<?php echo $assistantData->category_image ?>"></div>
								<div class="widget-user-name"><span class="w700"><?= $assistantData->name ?></span><br><span class="text-muted"><?= $assistantData->category_name ?></span></div>
							</div>
						</div>
						<div class="w-100 w-md-50 text-end pt-2 pb-2 inl">			
						    
						     <?php  if($assistantData->purpose == 'chat'){ ?>
							<a class="template-button me-2" ng-href="{{ wordUrl }}"  data-toggle="tooltip" data-placement="top"  title="Export Chat Conversation as Word File"><i class="fa-solid fa-file-word table-action-buttons table-action-buttons-big edit-action-button"></i></a>
							<a class="template-button me-2" href="{{ pdfUrl}}" data-toggle="tooltip" data-placement="top"  title="Export Chat Conversation as PDF File"><i class="fa-solid fa-file-pdf table-action-buttons table-action-buttons-big edit-action-button"></i></a>
							<a class="template-button me-2" href="{{ textUrl}}" data-toggle="tooltip" data-placement="top"  title="Export Chat Conversation Text File"><i class="fa-solid fa-file-lines table-action-buttons table-action-buttons-big edit-action-button"></i></a>
							 <?php } ?>
							<a id="" class="template-button me-2 chat-sidebar-container-btn d-inline-block d-md-none" href="#"><i class="fa-solid fa-bars-staggered table-action-buttons table-action-buttons-big edit-action-button d-none"></i></a>
					...
					<div class="chatbox" id="myDIV">
                       <div class="chatbox-area" id="messageBody">
                          <span ng-repeat="chat in chating">
                             <div class="receiver-msg mt20" ng-if='chat.human'>
                                <div class="receiver-text" data-conversation_id={{chat.id}} data-type="{{chat.type}}">
                                   {{chat.human}}
                                </div>
                                <div class="">
                             ...
                             <div class="sender-msg mt20" ng-if='chat.ai'>
                                <div class="">
                                   ...
                                   <img src="<?= $assistantData->category_image ?>"
                                      alt="Sender" class="img-fluid d-block sender-img" width="60"
                                      style="border-radius:50%">
                                         
                                </div>
                                <div ng-if="chat.type=='chatgpt'" class="sender-text" id="copyContent{{chat.id}}" style="white-space: pre-line;">
                                ...
                                <div class="sender-text" ng-if="chat.type !='chatgpt'">
                                    <div class="row gallery">
                                       <div class="col-xs-12 col-sm-6 col-lg-4" ng-repeat="(key, image) in chat.ai">
                                          <div class="library-result" ng-show="image.file_type =='image'">
                                             <div class="overlay">
                                                ...
                                                <a href="javascript:void(0)" ng-click="downloadFile(image.largeImageURL,'png')" title="Download"><i
                                             ...
                                             <div class="overlay">
                                                ...
                                                <a href="javascript:void(0)" ng-click="saveToGallery(key,image)"
                                                   title="Add"><i class="fa-solid fa-bookmark"></i></a>
                                                    <a href="javascript:void(0)" ng-click="downloadFile(image.largeImageURL,'gif')" title="Download"><i
                                                   class="fa-solid fa-download"></i></a>   
                                             </div>
                                          ...
                                          <div class="library-result" ng-show="image.file_type =='video'">
                                             <div class="overlay">
                                                ...
                                                <a href="javascript:void(0)" ng-click="saveToGallery(key,image)"
                                                   title="Add"><i class="fa-solid fa-bookmark"></i></a>
                                                   <a href="javascript:void(0)" ng-click="downloadFile(image.small_video,'mp4')" title="Download"><i
                                                   class="fa-solid fa-download"></i></a>   
                                             </div>
                                             <img src="{{ image.largeImageURL }}" style="height:200px;" alt="Video"
                                                class="img-fluid d-block mx-auto">
                                          </div>
                                       </div>
                                    </div>
                     ...
                     <div class="col-12 mt20">
                        <div class="row gallery">
                           <div class="col-xs-12 col-sm-6 col-lg-4" ng-repeat="(key, image) in imagesList">
                              <div class="library-result" ng-show="image.file_type =='image'">
                                 <div class="overlay">
                                    <a title="select">
                                    <span class="carouselGallery-col-1 carouselGallery-carousel"
                     ...
                     <div class="row mt20">
                       ...
                       <div class="chatbox-sendbox">
                          ...
                          <div class=" d-flex" style="<?php echo $assistantData->assistant_status == 'super_vachat' ? 'padding:20px 0px' : '' ?>" >
                           ...
                           <?php  if($assistantData->purpose!= 'chat'){ ?>
                             ...
                             <?php } ?> 
                             <div class="flex-xs-column d-md-flex align-items-center justify-content-between w100 bussiness-box">
                                <div class="send-msg chatbox-input">
                                   ...
                                   <textarea class="dash-input form-control" id="inputText" placeholder="Type here..."
                                      ng-model="chat"></textarea>
                                </div>
                                <div class="send-box d-flex send-box align-items-center">
                                    <?php  if($assistantData->purpose == 'chat'){ ?>
                                                                     
                                    <a class="template-button me-2" href="#" data-bs-toggle="modal"
                                            data-bs-target="#openPromt" data-toggle="tooltip" data-placement="top"  title="Prompt Library"><i class="fa-solid fa-book table-action-buttons table-action-buttons-big edit-action-button"></i></a>
                                      <?php } ?>      
        							<!-- <a class="template-button" href="#" id="myImage"><span id="mic" class="mic-off mr10 table-action-buttons table-action-buttons-big edit-action-button"></span></a> -->
                                   ...
                                   <a href="" class="send-btn" ng-click="addMessage()"><span  class="d-none d-md-inline-block">Send </span> <i class="fa-solid fa-paper-plane ms-md-1"></i></a>
                                </div>
                             </div>
                          </div>
                       </div>
         ...
         <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header mb-3">
                    <h5 class="fw-normal modal-title">Rename Your Chat</h5>
                </div>
               <form ng-submit="updateTitle()">
                  <div class="modal-body p-15 p-md30">
                     <div class="form-group d-gblue-clr f-14">
      ...
      <div class="modal fade" id="StockVideosPopup" tabindex="-1"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                           ...
                           <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                 ...
                                 <div class="col-lg-4 col-md-6">
                                    <div class="search-bar">
                                       <input type="text" class="search form-control"
                                          placeholder="Search.." ng-model="filterfolder">
                                 ...
                                 <div class="col-lg-8 col-md-6 text-md-end">
                                    <div class="create-btn">
                                       ...
                                       <span class="icon-create-new-campaign"
                                        ...
                                        <a href="#" class="" style="font-size: 16px;"
                                          ng-if="data.level == 1" ng-click="load_folders()">
                                           &lt;--
                                          Back
                                       </a>
                                       <a href="#" class="" style="font-size: 16px;"
                                          ng-if="data.level == 1" ng-click="saveAssets()">
                                       Save
                                       </a>
                              ...
                              <div class="row row-cols-1 row-cols-md-4 mt20 mt-md0">
                                 <div class="col mt20 mt-md30" ng-repeat="(key, val) in data.records | filter:filterfolder">
                                    ...
                                    <div class="folder-wall" ng-if="val.file_type == '1' ">
                                       <div class="btn-group dropstart dash-drop">
                                          ...
                                          <ul class="dropdown-menu ">
                                             <li><a href="#" ng-click="initialize_rename(val)"><span
                                                class="icon-list-edit"></span> Rename</a></li>
                                             <li><a href="" ng-click="downloadFile(val.file,val.file_extension)"><span class="icon-library-download"></span> Download</a></li>
                                             <li><a href="" ng-click="initialize_delete(val)"><span
                                                class="icon-list-delete"></span> Delete</a></li>
                                          </ul>
                                       </div>
                                    ...
                                    <div class="folder-wall" ng-if="val.file_type == '2' ">
                                       ...
                                       <div class="appoint-inner">
                                          ...
                                          <a href="#">
                                            <video style="width:100%;"    controls> <source ng-src="{{val.file | trustUrl}}" /> 
      ...
      <div class="modal fade confirm-del openPromt" id="openPromt" tabindex="-1"
         aria-labelledby="openPromt" aria-hidden="true">
         <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
               <div class="modal-header">
               ...
               <div class="modal-body">
                    <h5 class="modal-title text-center" id="openPromt"><i class="fa-solid fa-book me-1"></i> <?= $assistantData->name ?></h5>
                  <div class="row ">
                              ...
                              <div class="row mt20">
                                 <div class="col-12 col-md-12">
                                    <div class="search-bar">
                                       ...
                                       <input type="text" class="search2 form-control ng-pristine ng-untouched ng-valid" placeholder="Search.." ng-model="promptfilter">
                                       
                                    </div>
                                 </div>
                              </div>
                              
                              <div class="row row-cols-1 row-cols-md-2 mt20 mt-md0">
                                 <div class="col mt20 mt-md30"   ng-repeat="prom_det in prompt_detail | filter: promptfilter" ng-click="promptHit(prom_det.prompt)">
                                    <div class="promt-wall text-start">
                                       <h6 style="color:var(--white-color)">{{ prom_det.title }}</h6>
                                       <p> {{ prom_det.prompt }} </p></div>
                                 </div>
                              </div>
                           </div>
                           <!-- ---tab-pane---conversation End -->
 ...
 app.filter('strReplace', function () {
   ...
   app.controller("conversationCtrl", function ($scope, $http, $timeout, webServices) {
    ...
    //   $scope.superVapurpose = "<?php echo !empty($assistantChatInfo->purpose) ? $assistantChatInfo->purpose : 'chat'; ?>"
      $scope.vaPurpose = "<?php echo !empty($assistantChatInfo->purpose) ? $assistantChatInfo->purpose : 'images'; ?>"
    //   $scope.language = "<?php echo $assistantChatInfo->language; ?>"
