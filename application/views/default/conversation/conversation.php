...
<div class="container-wrapper container-open"  ng-app="AppModule" ng-controller="virtualAssitant" ng-cloak>
	 ...
	 <div class="container-fluid container-padding artist-container">
		 <div class="row ">
			<div class="col-lg-4">
				<div class="row">
							...
							<div class="tab-pane fade show active" id="imagetoimage" role="tabpanel" aria-labelledby="imagetoimage-tab">
								...
								<div class="comman-ai-box d-flex flex-column row-gap-2">
									<div class="d-flex justify-content-between align-items-center">
										...
										<a href="<?php echo base_url(); ?>ai-art" class="btn btn-primary" style="font-size: 16px;"> <span>&lt;--</span> Back</a>
									</div>
									<form method="post" enctype="multipart/form-data">
										<div>
											<select class="form-control selectpicker" ng-model="vaPurpose" ng-change="setSuperVapurpose()" ng-init="vaPurpose = vaPurpose || 'images'">
										...
										<div class="prompt-box">
											<label class="form-label">Enter A Keyword</label> <span class="text-danger asterisk">*</span>
							...
							<div ng-if="chat.type !='chatgpt'">
								<div class="h-auto m-0 row">
									<div class="col-md-6 col-xl-4 mt20" ng-repeat="(key, image) in chat.ai">
										<div class="select-style-wrapper select-style-wrapper-style-2 with-icons" ng-show="image.file_type =='image'">
		                                    <div class="top-right">
		                                        <a href="javascript:void(0);" ng-click="share_modal(image.largeImageURL)"><i class="fa-solid fa-share"></i></a>
		                                        <a href="javascript:void(0);"  ng-click="showConversationModal(image.largeImageURL, 'img');"><i class="fa-solid fa-eye"></i></a>
		                                    </div>
		                                    <img src="{{ image.largeImageURL }}" alt="Image" class="img-fluid mx-auto d-block">
		                                    <p class="heading d-flex align-items-center justify-content-between">
		                                        <a href="javascript:void(0);" class="download-icon" ng-click="downloadFile(image.largeImageURL,'png')">
		                                            <i class="fa-solid fa-download"></i>
		                                        </a>
		                                    </p>
		                                </div>
		                                <div class="select-style-wrapper select-style-wrapper-style-2 with-icons" ng-show="image.file_type =='gifs'">
		                                    <div class="top-right">
		                                        <a href="javascript:void(0);" ng-click="share_modal(image.largeImageURL)"><i class="fa-solid fa-share"></i></a>
		                                        <a href="javascript:void(0);"  ng-click="showConversationModal(image.largeImageURL, 'img');"><i class="fa-solid fa-eye"></i></a>
		                                    </div>
		                                    <img src="{{ image.largeImageURL }}" alt="Gifs" class="img-fluid mx-auto d-block">
		                                    <p class="heading d-flex align-items-center justify-content-between">
		                                        <a href="javascript:void(0);" class="download-icon" ng-click="downloadFile(image.largeImageURL,'png')">
		                                            <i class="fa-solid fa-download"></i>
		                                        </a>
		                                ...
		                                <div class="select-style-wrapper select-style-wrapper-style-2 with-icons" ng-show="image.file_type =='stickers'">
		                                    <div class="top-right">
		                                        <a href="javascript:void(0);" ng-click="share_modal(image.largeImageURL)"><i class="fa-solid fa-share"></i></a>
		                                        <a href="javascript:void(0);"  ng-click="showConversationModal(image.largeImageURL, 'img');"><i class="fa-solid fa-eye"></i></a>
		                                    </div>
		                                    <img src="{{ image.largeImageURL }}" alt="Stickers" class="img-fluid mx-auto d-block">
		                                    <p class="heading d-flex align-items-center justify-content-between">
		                                        <a href="javascript:void(0);" class="download-icon" ng-click="downloadFile(image.largeImageURL,'gif')">
		                                            <i class="fa-solid fa-download"></i>
		                                        </a>
		                                    </p>
		                                </div>
		                                <div class="select-style-wrapper select-style-wrapper-style-2 with-icons" ng-show="image.file_type =='video'">
		                                    <div class="top-right">
		                                        <a href="javascript:void(0);" ng-click="share_modal(image.largeImageURL)"><i class="fa-solid fa-share"></i></a>
		                                        <a href="javascript:void(0);"  ng-click="showConversationModal(image.small_video, 'video');"><i class="fa-solid fa-eye"></i></a>
		                                    </div>
		                                    <img src="{{ image.largeImageURL }}" alt="Video" class="img-fluid mx-auto d-block">
		                                    <p class="heading d-flex align-items-center justify-content-between">
		                                        <a href="javascript:void(0);" class="download-icon" ng-click="downloadFile(image.small_video,'mp4')">
		                                            <i class="fa-solid fa-download"></i>
		                                        </a>
		                                    </p>
		                                </div>
