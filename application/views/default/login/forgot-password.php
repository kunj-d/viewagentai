...
<head>
    ...
    <title><?php echo $this->config->item('productName') ?> | Forgot Password</title>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap"
        rel="stylesheet">
    <?php $this->load->view('default/login/login-header.php'); ?>
            ...
            <div class="row m-0 h-100 align-items-center justify-content-center">
                ...
                <div
                    ...
                    <div class="auth-section">
                        ...
                        <div class="heading">Trouble Logging in ?</div>
                        <div class="sub-heading sub-heading-border">Enter your email and we'll send you a link to <br>
                            get back into your account.</div>
                        <div class="login-form" style="margin-top:30px;">
                            <form action="<?= base_url('forgot-password'); ?>" method="post" class="form_ajax">
                                <div class="form-item text-start">
                                    ...
                                    <div class="form-item-in">
                                        ...
                                        <input type="email" id="username" class="form-control"
                                            placeholder="Enter Your Email" value="" name="email" autocomplete="off"
                                            aria-describedby="emailHelp">
                                    </div>
                                </div>
                                <div class="form-footer btn-wrapper-login">
                                    <button type="submit" name="login" class="signbtn btn-block">Send Reset Link
                                    </button>
                                </div>
                                <div class="signup text-center text-darj mt-2">
                                    Back to <a href="<?= base_url('login'); ?>" class="w600 dark-link">Log in</a>
                                </div>
                            </form>
                        </div>
                    </div>
