...
<body class="h-100">
    <div class="checkStatus NotValid">
        ...
        <span class="special invalid" data-text="One special character (!@#$%^&*)">❌ One special character
            (!@#$%^&*)</span>
                ...
                <div
                    ...
                    <div class="auth-section">
                        <div class="login-form">
                            <form
                                action="<?php echo base_url('reset-password'); ?>?code=<?php echo $this->input->get('code'); ?>&email=<?php echo $this->input->get('email'); ?>"
                                method="post" class="form_ajax">
                                <div class="text-center">
                                    <div class="form-icon">
                                        <img src="<?= $this->config->item('assetsPath') ?>images/password-icon.png"
                                            alt="">
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-item text-start">
                                        ...
                                        <div class="form-item-in">
                                            ...
                                            <span class="form-control-feedback toggle-password"
                                    ...
                                    <div class="form-item text-start">
                                        ...
                                        <div class="form-item-in">
                                            ...
                                            <input type="password" name="cpassword" placeholder="Confirm Password"
                                                value="" id="cpassword-field" autocomplete="off" class="form-control">
                                            <span class="form-control-feedback toggle-password"
