    ...
    .user-section-card {
        .top-content {
            ...
            p {
                ...
                text-shadow: 1px 2px rgba(219, 26, 26, 0.6);
            }
        }
    }
</style>
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Urbanist:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Login | <?php echo $this->config->item('productName'); ?></title>
    <meta name="description"
        content="Access your Tube Claw AI dashboard. Login to manage your channels, Claw Agent commands, projects & account.">
    <link rel="canonical" href="https://www.tubeclawai.com/login" />
    <meta property="og:title" content="Login | <?php echo $this->config->item('productName'); ?>" />
    <meta property="og:url" content="https://www.tubeclawai.com/login" />
    <meta property="og:type" content="App" />
    <meta property="og:site_name" content="tubeclawai" />
    <meta property="og:description"
        content="Access your Tube Claw AI dashboard. Login to manage your channels, Claw Agent commands, projects & account." />
    <meta property="og:image" content="<?= $this->config->item('assetsPath') ?>images/meta-banner.png" />
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@tubeclawai" />
    <meta name="twitter:title" content="Login | <?php echo $this->config->item('productName'); ?>" />
    <meta name="twitter:description"
        content="Access your Tube Claw AI dashboard. Login to manage your channels, Claw Agent commands, projects & account." />
    <meta name="twitter:image" content="<?= $this->config->item('assetsPath') ?>images/meta-banner.png" />
    <?php
    ...
    <div class="auth-wrapper">
        <div class="container-fluid h-100 p-0">
            <div class="row m-0 h-100 align-items-center justify-content-center">
                <div class="col-lg-7 d-none d-lg-flex align-items-center h-100">
                    <div class="user-section-card d-flex flex-column gap-2 justify-content-between">
                        <div class="top-content">
                            <div class="d-flex align-items-center gap-3 mb-2">
                                <div class="head-img">
                                    <img src="<?= $this->config->item('assetsPath') ?>images/post-gen-logo.png"
                                        class="img-fluid">
                                </div>
                                <h3><span class="text-primary">Tube</span> Claw AI</h3>
                            </div>
                            <p>
                                One Command to Claw Agent to build, rank & grow your YouTube channels.
                            </p>
                        </div>
                        <div class="bottom-content w-100 overflow-hidden">
                            <div class="media-img">
                                <img src="<?= $this->config->item('assetsPath') ?>default/images/login-pr-thumb.png"
                ...
                <div
                    class="col-lg-5 text-center h-100 d-flex align-items-center justify-content-center flex-column position-relative overflow-hidden z-1">
                    <div class="auth-section">
                        <div class="logo-media mx-auto d-none">
                            <img src="<?= $this->config->item('assetsPath') ?>default/images/login-logo.png"
                                class="img-fluid mx-auto d-block">
                        </div>
                        <div class="heading">Welcome To <span class="text-primary">TubeClaw AI</span></div>
                            ...
                            <div class="form">
                                <div class="form-item text-start">
                                    ...
                                    <div class="form-item-in">
                                        ...
                                        <input type="email" id="username" placeholder="Enter Your Email" value=""
                                            name="email" autocomplete="off" class='form-control '>
                                    </div>
                                </div>
                                ...
                                <div class="form-item mb0 text-start">
                                    ...
                                    <div class="form-item-in mb-2">
                                        ...
                                        <input type="password" name="password" placeholder="Enter Your Password"
                                            value="" id="password-field" autocomplete="off" class='form-control '>
                                        <span class="form-control-feedback toggle-password" toggle="#password-field"><i
                                                class="icon-password-view"></i></span>
                                    </div>
                                    <div class="text-align-left mt-2">
                                        <a tabindex="-1" href="<?= base_url('forgot-password'); ?>"
