...
<head>
    ...
    <title><?php echo $this->config->item('productName'); ?> After Reset</title>
    ...
    <title><?php echo $this->config->item('productName') ?> | Forgot Password Success</title>
    <?php
                        ...
                        <div class="login-form d-inline-block">
                            <form action="">
                                <div class="text-center">
                                    <div class="form-icon">
                                        <img src="<?= $this->config->item('assetsPath') ?>images/right-icon.png" alt=""
                                            class="img-fluid mx-auto d-block">
                                    </div>
                                    <h5 class="headingsub-heading-border my-3 text-white">Your password has been successfully
                                        reset.</h5>
                                </div>
                                <div class="form-footer btn-wrapper-login">
                                    <a href="<?= base_url('login') ?>" class="signbtn btn-block">Back to Log
                                        In</a>
                                </div>
                            </form>
                        </div>
