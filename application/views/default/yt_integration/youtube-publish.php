										...
										<div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
											<div class="accordion-body">
												<div class="form-check mb-2">
													<input class="form-check-input" type="checkbox" ng-model="publishtype" value="" id="flexCheck1" style="background: var(--theme-bg);border: 1px solid var(--theme-br);">
												...
												<!-- <p>Select a date to make your video public.</p> -->
												 <div ng-show="!videoId">
													 <div class="form-group w-50 mb-3">
														 ...
														 <input class="form-control custom-datetime" ng-class="{'pointerdisable': publishtype}" type="datetime-local" ng-model="scheduletime" id="schedule" name="schedule">
													 </div>
			...
			<div class="chat-wrapper" ng-repeat="chat in chat_history">
				...
				<div class="ai-msg">
					...
					<div class="position-relative ai-image">
						...
						<img ng-src="{{chat.ai_response}}" class="img-fluid rounded-3 shadow-sm" style="max-width: 250px;" alt="Generated Thumbnail">
					</div>
				</div>
			</div>
		</div>
