...
<?php
$add_new_membar_btn = '<a class="btn btn-primary" href="'.site_url('add-team-member').'">Add New Team</a>';
?>
                ...
                <div class="feature-banner">
                    <div class="row align-items-center justify-content-between g-0">
                        <div class="col-auto feature-wrap">
                            <h5 class="feature-title">Team Management</h5>
														...
														<tr>
															...
															<td>
																<div class="action-link">
																	<a href="<?= site_url('edit-team-member/' . $conversation['id']) ?>" class="action-btn blue-btn-outline" title="Edit">
...
app.controller('customersCtrl', function($scope, $http) {
	...
	var list_url = siteUrl+'get-team-list-json';
