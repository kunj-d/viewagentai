<title><?php echo $this->config->item('productName') ?> | Post Generator</title> 
<?php 
$activeFile = null;
$Created = null;
$Updated = null;
 $url = base_url()."app/pwa/index.html"; 
...
<div class="container-wrapper container-open" ng-app="AppModule" ng-controller="PostController">
    <div class="container-fluid container-padding p-0">
        ...
        <div class="header-stripe">
            <div class="d-flex align-items-center">
                ...
                <p style="color:#FFFFFF;">View Agent</p>
            </div>
            <a href="javascript:void(0);" class="btn btn-white" data-bs-toggle="modal" data-bs-target="#integrationModal">Connect Telegram / Install Aap</a>
        </div>
        <section class="ai-command-section" ng-class="{'chat-wrapper-active': isChatActive}">
            <div class="row h-100 w-100">
                <div class="col-12 h-100">
                    <div class="ai-command-inner">
                        <div class="ai-command-header mt-auto">
                            <div class="ai-command-icon">
                                <img src="<?php echo $this->config->item('assetsPath') ?>images/post-gen-logo.png" alt="Post Gen Logo">
                            </div>

                            <h2 class="ai-command-title">
                                <span class="text-primary">View</span> Agent
                            </h2>
                            ...
                            <div class="post-chat-container" id="chatContainer">
                                <div ng-repeat="msg in messages track by $index">
                                    ...
                                    <div class="chat-message chat-message-right" ng-if="msg.type == 'user'">
                                        ...
                                        <div class="chat-avatar">
                                            <img src="<?= ($this->session->userdata('logged_in')['profile_pic'] == '' || $this->session->userdata('logged_in')['profile_pic'] == "default_profile.png") ? $assetsPath . 'default/images/default_profile.png' : $this->config->item('bucket_url') . $this->session->userdata('logged_in')['profile_pic']  ?>" alt="Product Icon">
                                        </div>
                                    </div>
                            
                                    <!-- BOT TEXT -->
                                    <div class="chat-message chat-message-left" ng-show="msg.type == 'bot' && !msg.subType && !msg.hidden">
                                        <div class="chat-avatar">
                                    ...
                                    <div class="chat-message chat-message-left" ng-if="msg.subType == 'integration_required'">
                                        <div class="chat-avatar">
                                            <img src="<?php echo $this->config->item('assetsPath') ?>images/Ai-Employee-Favicon.png" alt="Product Icon">
                                        </div>
                                        ...
                                        <div class="chat-card">
                                            <div class="chat-content">
                                                ...
                                                <div class="d-flex align-items-center gap-1">
                                                    ...
                                                    <a href="<?php echo base_url('integration')?>" target="_blank" class="btn btn-primary">
                                                        connect your social accounts
                                                    </a>
                            
                                                    <a href="javascript:void(0);" class="btn btn-secondary" ng-click="regenerate()">
                                                        Regenerate
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="chat-message chat-message-left" ng-if="msg.subType == 'choose_type'">
                                        <div class="chat-avatar">
                                            <img src="<?php echo $this->config->item('assetsPath') ?>images/Ai-Employee-Favicon.png" alt="Icon">
                                        </div>
                                        <div class="chat-bubble">
                                            <p>{{msg.text}}</p>
                                            <div class="d-flex gap-2 mt-2">
                                                <button class="btn btn-primary btn-sm" ng-click="generatePost('avatar')">
                                            ...
                                            <div class="chat-content">
                                                ...
                                                <div class="video-area">
                                                  ...
                                                  <div class="d-flex align-items-center justify-content-center gap-1 mt-2">
                                                      <a ng-href="{{ msg.videoType == 'avatar' ? baseUrl + 'video-editor-list': baseUrl + 'video-editor-list' }}"class="btn btn-primary">
                        ...
                        <div class="ai-command-box">
                            ...
                            <div class="ai-command-mic" ng-click="startListening()">
                                ...
                                <path d="M9 0C7.13672 0 5.625 1.51172 5.625 3.375V9C5.625 10.8633 7.13672 12.375 9 12.375C10.8633 12.375 12.375 10.8633 12.375 9V3.375C12.375 1.51172 10.8633 0 9 0ZM4.5 7.59375C4.5 7.12617 4.12383 6.75 3.65625 6.75C3.18867 6.75 2.8125 7.12617 2.8125 7.59375V9C2.8125 12.1324 5.13984 14.7199 8.15625 15.1312V16.3125H6.46875C6.00117 16.3125 5.625 16.6887 5.625 17.1562C5.625 17.6238 6.00117 18 6.46875 18H9H11.5312C11.9988 18 12.375 17.6238 12.375 17.1562C12.375 16.6887 11.9988 16.3125 11.5312 16.3125H9.84375V15.1312C12.8602 14.7199 15.1875 12.1324 15.1875 9V7.59375C15.1875 7.12617 14.8113 6.75 14.3438 6.75C13.8762 6.75 13.5 7.12617 13.5 7.59375V9C13.5 11.4855 11.4855 13.5 9 13.5C6.51445 13.5 4.5 11.4855 4.5 9V7.59375Z" fill="white"/>
                                </svg>

                            </div>

                            <textarea ng-keydown="checkEnter($event)" class="ai-command-input" placeholder=" Enter Your Prompt..." ng-model="commandText"></textarea>

                            <button class="ai-command-button" ng-click="generatePost()">
                                <span>Generate</span> <i class="fa-solid fa-play"></i>
                            </button>
...
<!-- Modal -->
<div class="modal modal-integration fade" id="integrationModal" tabindex="-1">
        ...
        <div class="modal-content custom-modal">
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <input type="text" id = "bot_token" ng-model="telegram.bot_token"
                            class="form-control custom-input"
                            placeholder="Enter Bot Username">

                    <div class="text-end mt-5">
                        <button class="btn btn-primary" ng-click="connectTelegram()">
                            Connect
                        </button>
                    </div>
             ...
             <!-- Tabs -->
            <ul class="nav nav-tabs custom-tabs border-0" id="botTabs">
                <li class="nav-item w-50">
                    <button class="nav-link active w-100" data-bs-toggle="tab" data-bs-target="#telegram">
                        Telegram
                    </button>
                </li>

                <li class="nav-item w-50">
                    <button class="nav-link w-100" data-bs-toggle="tab" data-bs-target="#pwa">
                        Install App
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="telegram">
                    ...
                    <!--        placeholder="Enter Bot Username">-->
                    <input type="text"
                   ng-model="telegram.bot_token"
                   class="form-control custom-input"
                   placeholder="Enter Telegram Bot Token"
                   ng-readonly="telegram.is_connected">
                  
                     <!--<input type="text" id = "bot_token" ng-model="telegram.bot_token"-->
                     <!--       class="form-control custom-input"-->
                     <!--       placeholder="Token">-->
                     
                     <!--<div ng-if="telegram.is_connected">-->
                     <!--    <lable class = "form-label custom-label mt-3">-->
                     <!--        Token-->
                     <!--    </lable>-->
                  ...
                  <div class="d-flex align-items-center justify-content-between flex-wrap mt-4">   
                    <button type="button" class="btn btn-white" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                        How To Connect Telegram
                    </button>
                    <div>
                        <button class="btn btn-primary me-2" ng-if="telegram.is_connected" 
                            ng-click="resetTelegram()">
                            Reset
                        </button>
                        
                        <button class="btn btn-primary"
                                ng-if="!telegram.is_connected"
                                ng-click="connectTelegram()">
                            Connect
                        </button>
...
<div class="modal fade modal-watch-training" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h1 class="modal-title title-line" id="exampleModalCenterTitle">How To Connect Telegram</h1>
                    <p class="desc mb-0">Connect your Telegram and access it directly from Telegram.</p>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="video-demo mt-0">
                    <iframe src="https://tube-claw-ai.dotcompal.co/video/embed/jzbqyrcuki" data-videosrc="https://tube-claw-ai.dotcompal.co/video/embed/jzbqyrcuki" frameborder="0" allow="autoplay; fullscreen" allowfullscreen=""></iframe>
                </div>
            </div>
...
<script>
     ...
     var hasPwaFeature = <?= in_array('pwa', $this->session->userdata('features')) ? 'true' : 'false' ?>;
    ...
    $scope.checkEnter = function(event) {
        ...
        $(document).on('show.bs.tab', '[data-bs-target="#pwa"]', function (e) {
...
// };
 ...
 $scope.generatePost = function(selectedType){
    ...
    if (!videoType) {
        ...
        if (typeof jsLoaderTubeclaw === "function") {
            jsLoaderTubeclaw(true);
        } else {
            jsLoader(true);
        }
    }
    ...
    $scope.regenerate = function () {
        ...
        $scope.social_media_post = function(video) {
            var queryStr = "<?php echo base_url('post-social-media')?>";
