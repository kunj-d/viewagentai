    ...
    <div class="container-wrapper container-open">
        ...
        <title><?php echo $this->config->item('productName') ?> | Add New Team </title>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-7 col-xs-12">
                                        ...
                                        <h1 class="md20 title-line lh110">Add a New Team </h1>

                                        <p class="container-page-subtitle">Add your Teams Here</p>
                                ...
                                <div class="whitesection add-member">
                                    ...
                                    <div class="row mb20 align-items-center">
                                        ...
                                        <div class="col-lg-4 col-md-5 col-sm-8 col-xs-12 mb20">
                                            ...
                                            <input type="text" placeholder="Enter Your Team  Name" class="form-control search1" name="name" id="name">
                                    ...
                                    <div class="row mb20 align-items-center">
                                        ...
                                        <div class="col-lg-4 col-md-5 col-sm-8 col-xs-12 mb20">
                                            ...
                                            <input type="text" placeholder="Enter Your Team  Email" class="form-control search1" name="email" id="email">
                                    ...
                                    <div class="row mb20 align-items-center">
                                        ...
                                        <ul class="md14 f-14 f-md-14 ps-3">
                                            <li>All fields are required. Once you click 'Add Team,' the system will automatically send login details to the specified email address.</li>
                                        </ul>
                                           

                                    <!--    <div class="col-lg-1 col-md-3 col-sm-4 col-xs-12 mb20">-->

                                    <!--        <label class="white-clr">User Level<span class="red">*</span></label>-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 d-flex justify-content-start  ">
                                            ...
                                            <a href="<?= base_url('team-management') ?>" class="btn btn-outline mr10">Cancel</a>

                                            <input type="submit" class="btn btn-primary save-data" value="Add Team ">
    ...
    $(document).on('click', ".save-data", function () {
       ...
       // jsLoader(true);
        ...
        $.ajax({
            ...
            data: {user_name: user_name, user_email: user_email, business: business},
