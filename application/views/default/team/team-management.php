...
<link rel="stylesheet" href="https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap5.min.css">   
    ...
    <div class="container-wrapper container-open" >
        ...
        <title><?php echo $this->config->item('productName') ?> | Team Management</title>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row row-gap-2">
                                    <div class="col-md-8 ">
                                        ...
                                        <h1 class="md30 title-line lh110">Team Management</h1>

                                        <p class="container-page-subtitle">Create & manage all Team's here</p>

                                    </div>
                                    <div class="col-md-4 ">
                                        <div class="create-btn text-end mb-3">
                                            <a href="<?php echo base_url('add-team-member')?>" class="appoint-link"><span class="icon-create-new-campaign"></span>&nbsp;&nbsp; Add New</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-center justify-content-sm-end">
                                            ...
                                            <!--            <input type="text" class="search form-control" placeholder="Search.." ng-model="productParams.search_key" ng-change="getConversationList()">-->
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-inline-flex bg-transparent gap-3">

                                        <a href="<?php echo base_url() ?>edit-team-member/<?= $conversation['id'] ?>" class="action-btn btn-primary  sharp me-1"><i class="icon-list-edit icon-edit"></i></a>
...
<!-- Table end--> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 mt2 xsmt3">                       
                                            ...
                                            <div class="col-xs-12 padding0 footer-height">
                                                ...
                                                <div class="md16 sm15 xs15 w600 text-center mt1 xsmt2">No Team Member Found</div>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            url: siteUrl + 'delete-team-member-json',
    ...
    app.controller('customersCtrlfdf', function($scope, $http) {
     ...
     $scope.getConversationList = function (){
        ...
        var search_url="<?= base_url().'get-team-list-json' ?>";		
...
$scope.toggleAll = function () {
  ...
  $scope.uncheck = function () {
   ...
   function jsLoader(add){
        ...
        if(add){ 
            $("body").append('<div class="temp_js_loader" style="background: rgba(200, 200, 200, 0.34);width: 100%;height: 100%;position: fixed;top: 0px;left: 0px;z-index: 9999;"><img src="<?php echo $assetsFolder; ?>images/loading-icon.gif" style="position: absolute;margin: auto;top: 0;bottom: 0;left: 0;right: 0;"></div>');
        }	
