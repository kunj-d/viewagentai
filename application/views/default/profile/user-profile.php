                      ...
                      <!-- <form class="row" action="https://app.writerarc.com/save-user-profile">-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="password" class="form-control search1" id="current-pwd" name="current_password" placeholder="Enter Current Password" style="padding: 6px 15px;font-size: 22px;height: 43px;">
                                ...
                                <div class="col-md-6 mt20">
                                    ...
                                    <input type="password" class="form-control search1" id="new-pwd" name="new_password" placeholder="Enter New Password" style="padding: 6px 15px;font-size: 22px;height: 43px;">
                                ...
                                <div class="col-md-6 mt20">
                                    ...
                                    <input type="password" class="form-control search1" id="confirm-pwd" name="confirm_password" placeholder="Enter Confirm Password" style="padding: 6px 15px;font-size: 22px;height: 43px;">
