...
<title><?php echo $this->config->item('productName') ?> | Facebook Publisher </title>
...
<div class="container-wrapper container-open" ng-app="MyApp" ng-controller="fbCtrl">
                ...
                <div class="feature-banner">
                    <div class="row align-items-center justify-content-between g-0">
                        <div class="col-auto feature-wrap">
                            <h5 class="feature-title">Facebook Automation</h5>
                            <p class="feature-subtitle mb-0">
                                Choose or upload a video to post on Facebook
                            </p>
                        </div>
                        <div class="col-auto ms-auto">
                            <a href="javascript:void(0);" class="btn btn-primary" ng-click="uploadfbvideo()">Publish</a>                     
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="theme-wrapper h-100" >
                            <div class="title-head">
                                <h5 class="title">Facebook Post Setup</h5>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="story-post-toggle">
                                    <div>
                                        <input type="radio" class="btn-check" ng-click="get_post_type('video')" name="options-base" id="post" autocomplete="off" checked>
                                        <label class="btn" for="post">Media Post</label>
                                    </div>
                                    <div>
                                        <input type="radio" class="btn-check" ng-click="get_post_type('story')" name="options-base" id="story" autocomplete="off" >
                            ...
                            <div class="theme-box">
                                <label class="widget-box mb-2">
                                    ...
                                    <div class="icon-btn icon-lg bg-dark border radius-1">
                            ...
                            <div class="theme-bg-dark preview-wrapper">
                                <div class="mobile-frame">
                                    <div class="post-box fb-box">
                                        ...
                                        <!-- Actions -->
                                        <div class="action-row justify-content-between mb-2">
...
app.directive("fileInput", function () {
    ...
    app.controller('fbCtrl', function($scope, $http, $sce) {
    ...
    $scope.uploadfbvideo= function() {
        jsLoader(true);
        jsLoaderText('Your video is publishing... Please wait 10–15 seconds, then refresh',true)
          var queryStr = "<?php echo base_url('fb-post-video')?>";
            $http({
                method: 'POST',
                url: queryStr,
                aync: false,
                ...
                if (response.data.success) {
                    ...
                    toastr.success(response.data.msg);
                         window.location.href = "<?php echo base_url('facebook-publisher')?>";
