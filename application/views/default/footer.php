...
<script>
  ...
  function jsLoader(add) {
    ...
    if (add) {
        $("body").append(`
            <div class="temp_js_loader" style="
                background: rgba(0, 0, 0, 0.75); /* Thoda background aur dark kiya taaki video clear dikhe */
                width:100%;
                height:100%;
                position:fixed;
                top:0;
                left:0;
                z-index:99999; /* Z-index thoda badha diya backup ke liye */
                display:flex;
                flex-direction: column; /* Loader text add karne ka option milega */
            ...
            ">
                <div style="text-align: center;">
                    <video
                        ...
                        muted
                        playsinline
                        style="height:300px; width:300px; object-fit: contain; margin-bottom: 15px;" 
                    >
                        <source src="<?= base_url() ?>app/assets/images/tubeclaw_video_loader.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                    <div style="color: #ffffff; font-size: 18px; font-weight: 600; font-family: sans-serif; letter-spacing: 0.5px;">
                        Creating Your AI Video, Please Wait...
                    </div>
                </div>
            </div>
        `);
...
//     if (add) { 
//         $("body").append(
//             '<div class="temp_js_loader" style="background: rgba(0, 0, 0, 0.75); width:100%; height:100%; position:fixed; top:0; left:0; z-index:99999; display:flex; flex-direction: column; justify-content:center; align-items:center;">' +
//                 '<div style="text-align: center;">' +
//                     '<video autoplay loop muted playsinline style="height:300px; width:300px; object-fit: contain; margin-bottom: 15px;">' +
//                         '<source src="<?= base_url() ?>app/assets/images/tubeclaw_video_loader.mp4" type="video/mp4">' +
//                         'Your browser does not support the video tag.' +
//                     '</video>' +
//                     '<div style="color: #ffffff; font-size: 18px; font-weight: 600; font-family: sans-serif; letter-spacing: 0.5px;">Creating Your AI Video, Please Wait...</div>' +
//                 '</div>' +
//             '</div>'
//         ); 
//     } 
