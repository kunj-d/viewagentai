...
<title><?php echo $this->config->item('productName') ?> | Instagram Replay</title>
...
<div class="container-fluid container-padding padding-bonus">
    <div class="bonus-wrapper">
        ...
        <div class="row row-gap-2">
            <div class="col-12">
                <div class="title-line">Instagram Auto Reply</div>
                ...
                <div class="wrapper-box position-relative border-0" style="min-height: calc(100vh - 110px) !important;">
                    <div class="content-side">
                                        ...
                                        <div class="custom-upload-2" >
                                            <div class="file-post custom-file-upload">
                                                <div class="media-box mb-0">
                                                    <i ng-if="!selectedVideo.media_type" class=" fa-solid fa-film"></i>
                                                    <div class="image-thumbnail position-relative" ng-if="selectedVideo.media_type" ng-clock>
                                                ...
                                                <div ng-if="!selectedVideo.media_type" class="mt20" data-bs-toggle="modal" data-bs-target="#videoDetailsModal" style="cursor: pointer;">
                        ...
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-primary" ng-click="saveinstaReplyAutomation()">Save</button>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12" ng-repeat="video in all_videos" ng-click="selectVideo(video)">
                            <div class="d-block video-box">
                                ...
                                <div class="video-title">
                                    <h6 class="title">{{video.caption || 'No Title'}}</h6>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    //     };
        ...
        $scope.emptymedia =  function(){
			$scope.selectedVideo = { id : "", thumbnail : "" , media_url : "" };
			$scope.video_id = "";
		}
		
		$scope.saveinstaReplyAutomation = function() {
	            if(!$scope.video_id){
            ...
            jsLoader(true);
              var queryStr = "<?php echo base_url('save-insta-reply-automation')?>";
                $http({
                    method: 'POST',
                    url: queryStr,
                    aync: false,
