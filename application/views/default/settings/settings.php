...
<div class="container-wrapper container-open">
    <title><?php echo $this->config->item('productName') ?> | Settings</title>
        ...
        <div class="row">
            ...
            <?php if ($this->session->userdata('logged_in')['id'] == $this->session->userdata('logged_in')['owner_id']) { ?>
                ...
                <div class="col-lg-3 col-md-4">
                    <a href="<?= base_url('workspace') ?>" class="theme-shine-card style-2" data-tilt>
                         <img class="card-img-1" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-1.png" alt="">
                     <img class="card-img-2" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-2.png" alt="">
                        <!-- <div class="shine"></div> -->
            ...
            <div class="col-lg-3 col-md-4">
                <!-- <a href="<?= base_url('settings') ?>" class="theme-shine-card style-2" data-tilt> -->
                <a href="<?= base_url('subscription') ?>" class="theme-shine-card style-2" data-tilt>
                    <!-- <div class="shine"></div> -->
                     <img class="card-img-1" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-1.png" alt="">
                     <img class="card-img-2" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-2.png" alt="">
                    <div class="theme-card-icon">
            ...
            <?php if (($this->session->userdata('logged_in')['id'] == $this->session->userdata('logged_in')['owner_id']) || in_array('integration', $team_privileges)) { ?>
                <div class="col-lg-3 col-md-4">
                    ...
                    <!-- <a href="<?= base_url('settings') ?>" class="theme-shine-card style-2" data-tilt> -->
                    <a href="<?= base_url('integration') ?>" class="theme-shine-card style-2" data-tilt>
                        <!-- <div class="shine"></div> -->
                         <img class="card-img-1" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-1.png" alt="">
                     <img class="card-img-2" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-2.png" alt="">
                        <div class="theme-card-icon">
            ...
            <div class="col-lg-3 col-md-4 ">
                <!-- <a href="<?= base_url('settings') ?>" class="theme-shine-card style-2" data-tilt> -->
                <a href="<?= base_url('training') ?>" class="theme-shine-card style-2" data-tilt>
                    <!-- <div class="shine"></div> -->
                     <img class="card-img-1" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-1.png" alt="">
                     <img class="card-img-2" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-2.png" alt="">
                    <div class="theme-card-icon">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <!-- <a href="<?= base_url('settings') ?>" class="theme-shine-card style-2" data-tilt> -->
                <a href="<?= base_url('bonuses/vip-bonuses') ?>" class="theme-shine-card style-2" data-tilt>
                    <!-- <div class="shine"></div> -->
                     <img class="card-img-1" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-1.png" alt="">
                     <img class="card-img-2" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-2.png" alt="">
                    <div class="theme-card-icon">
            ...
            <div class="col-lg-3 col-md-4">
                <!-- <a href="<?= base_url('settings') ?>" class="theme-shine-card style-2" data-tilt> -->
                <a href="<?= base_url('faqs') ?>" class="theme-shine-card style-2" data-tilt>
                    <img class="card-img-1" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-1.png" alt="">
                     <img class="card-img-2" src="<?php echo $this->config->item('assetsPath') ?>images/card-img-2.png" alt="">
                    <!-- <div class="shine"></div> -->
                    <div class="theme-card-icon">
