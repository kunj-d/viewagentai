...
class Amazons3_video_Model extends CI_Model{
	...
	public function __construct() {   
		...
		$accessKey = config_item('aws_video_access_key');

		$secretKey = config_item('aws_video_secret_key');
	...
	*/
	...
	public static function putObjectFile($file, $bucket, $uri, $acl = self::ACL_PRIVATE, $metaHeaders = array(), $contentType = null) {
		...
		return self::putObject(Amazons3_video_Model::inputFile($file), $bucket, $uri, $acl, $metaHeaders, $contentType);
	...
	*/
	...
	public static function deleteObject($bucket = 'shortsaistudios', $uri = '') {
...
final class S3Request {
	...
	*/
	...
	public function getResponse() {
		...
		$headers[] = 'Authorization: ' . Amazons3_video_Model::__getSignature(
