...
class Amazons3_Model extends CI_Model{
	...
	public function __construct() {
    	...
    	$accessKey = config_item('aws_access_key');
		$secretKey = config_item('aws_secret_key');
	...
	*/
	...
	public static function putObjectFile($file, $bucket, $uri, $acl = self::ACL_PRIVATE, $metaHeaders = array(), $contentType = null) {
		...
		return self::putObject(amazons3_Model::inputFile($file), $bucket, $uri, $acl, $metaHeaders, $contentType);
	...
	*/
	...
	public static function deleteObject($bucket = 'viewagentai', $uri = '') {
...
final class S3Request {
	...
	*/
	...
	public function getResponse() {
		...
		$headers[] = 'Authorization: ' . amazons3_Model::__getSignature(
