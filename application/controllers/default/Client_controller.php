   ...
   //     } else {
    ...
    public function AddTeamMemberJson() {
        ...
        if ($this->input->post()) {
            ...
            $this->form_validation->set_rules('imageBalance', 'AI Credits', 'required|integer|greater_than_equal_to[50]');
            // $this->form_validation->set_rules('training_balance', 'Training Data Size', 'required|integer|greater_than_equal_to[2]');
