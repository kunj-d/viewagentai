...
class Images_loads_ajax extends CI_Controller {
    ...
    <div class="panel-body">
        <ul>
            <?php
            $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/basic_shapes/";
      
            $directory_images = glob($directory . "*.svg");
            
            foreach($directory_images as $img){
                $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
                echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg1')).'"></a></li>';
            }
            ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/dividers/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg2')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/abstract_shapes/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg3')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/badges/";
        $directory_images = glob($directory . "*.svg");

        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg4')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/ecommerce/";
        $directory_images = glob($directory . "*.svg");

        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg5')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/arrow/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg6')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/banners/";
        $directory_images = glob($directory . "*.svg");
         foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg7')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/holiday/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg8')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/button/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg9')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/social/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg10')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/emoji/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg11')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/object/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg12')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <ul>
        <?php
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/shape/seasonal/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
            echo '<li><a class="pg-element-svg"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_shape_msg13')).'"></a></li>';
        }
        ?>
        </ul>
    </div>
    ...
    public function library(){
        $directory = $this->config->item('assets_path') . "editor/assets/images/background/thumb/";
        $directory_images = glob($directory . "*.jpg");
        foreach($directory_images as $img){
            $img = str_replace($this->config->item('assets_path'), $this->config->item('assetsPath'), $img);
            echo '<div class="pg-imglist-item"><div class="ed_image pg_canvas_add_image" data-url="'.base_url() . 'app/assets/editor/assets/images/background/'.basename($img).'"><img src="'.$img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_library_msg1')).'"></div></div>';
        }
    ...
    public function library_bg(){
        ...
        foreach($directory_images as $img){
            $img = str_replace($this->config->item('assets_path'), $this->config->item('assetsPath'), $img);
            echo '<div class="pg-imglist-item"><div class="ed_image pg_canvas_bg_image" data-url="'.base_url() . 'app/assets/editor/assets/images/background/'.basename($img).'"><img src="'. $img.'" alt="'.html_escape($this->lang->line('ltr_images_loads_library_bg_msg1')).'"></div></div>';
        }
        $directory_images = glob($directory . "*.png");
        foreach($directory_images as $img){
            $img = str_replace($this->config->item('assets_path'), $this->config->item('assetsPath'), $img);
    ...
    public function pattern_load(){
        ...
        $directory = $_SERVER['DOCUMENT_ROOT'] . "/app/assets/editor/assets/images/element/pattern/";
        $directory_images = glob($directory . "*.svg");
        foreach($directory_images as $img){
            $img = str_replace($_SERVER['DOCUMENT_ROOT'], base_url(), $img);
        ...
        $a = json_decode($result,true);
            if(isset($a['data'])){
                foreach($a['data'] as $a_child){
                    ...
                    $img_url= base_url().'app/uploads/ai/'.$image_path.'.png'; 
            ...
            foreach($data['items'] as $item) {
                ...
                switch($size_leval){
                    case 'medium':
                        ...
                        $img_url= base_url().'app/uploads/youtube/'.$image_path.'.png';  
                    break;
                    case 'high':
