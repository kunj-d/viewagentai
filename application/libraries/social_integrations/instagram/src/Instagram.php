...
class Instagram
{
   ...
   */
  public function __construct($username,$password,$username_id,$token, $debug = FALSE, $IGDataPath = null)
  {
...
//        echo '<pre>';print_r($size);die;
   ...
   public function getTimeline($MaxId=null)
  {
	...
	if($MaxId==null)
        ...
        $timeline = $this->request("feed/timeline/?rank_token=$this->rank_token&ranked_content=true&max_id=$MaxId")[1];
  ...
  {
    return $this->request('friendships/followers/?ig_sig_key_version='.Constants::SIG_KEY_VERSION."&rank_token=$this->rank_token")[1];
  }
