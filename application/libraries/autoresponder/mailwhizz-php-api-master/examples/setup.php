...
$config = new MailWizzApi_Config(array(
    ...
    'publicKey'     => '27116a6d8335a6ead878aff82685f28f50906aed',
    'privateKey'    => 'f390673c240f438799c1d0e3f30e6ac8d100f91c',
    
    // components
    'components' => array(
        'cache' => array(
            'class'     => 'MailWizzApi_Cache_File',
            'filesPath' => './application/views/lib/mysticmailer-php-api-master/MailWizzApi/Cache/data/cache', // make sure it is writable by webserver
        )
    ),
));
