document.addEventListener("DOMContentLoaded", function () {
    ...
    if(element_id_script_pop){
        var element_id_pop = element_id_script_pop.getAttribute("element_id_pop"); 
    }
    if(!element_id_pop){
        var element_id_pop = "u9sst8htz0xhrrds";
    } 
    ...
    if (localStorage.getItem("visitor_id") === undefined || localStorage.getItem("visitor_id") === "" || localStorage.getItem("visitor_id") === null) {
        const unique_id_pop = localStorage.getItem("visitor_id");
        localStorage.setItem("visitor_id", generateSessionId_pop());
    }
    ...
    async function getStyle_pop() {
        ...
        try {
            ...
            if (json.not_active) {
                ...
                chatbot_background_pop = json.chatbot_background;
                ...
                if(assistant_image_pop != null){
                    ...
                    if (widgetlastWord_pop != 'widget.png') {
                        widget_image_pop = baseUrl_pop + json.widget_image;
                ...
                if (text_labeling_check_pop) {
                    if (text_labeling_check_pop == 0) {
                        if (json.chatbot_footer_pop != null) {
    ...
    (async () => {
        ...
        if (not_active_pop == null || not_active_pop == "") {
            ...
            htmlData_pop = `<link href="${baseUrl_pop}chat/copilot_style.css" rel="stylesheet">
                        ...
                        <section class="chat-user-card ${chatbot_class_pop}" id="chatbox_pop" style="color:${prompt_theme_text_color_pop};">
                            ...
                            <div class="header-1">
                                    ...
                                    <div class="cross-img-first">
                                        <i class="fa-solid fa-up-right-and-down-left-from-center expand" id="expand_head1_pop"></i>
                                        <i class="fas fa-compress-alt dexpand" id="dexpand_head1_pop" style="display:none"></i>
                                ...
                                <div class="header-2" style="display:none;">
                                    ...
                                    <div class="cross-img-second">
                                        <i class="fa-solid fa-up-right-and-down-left-from-center expand1" id="expand_head2_pop"></i>
                                        <i class="fas fa-compress-alt dexpand1" id="dexpand_head2_pop" style="display:none"></i>
                            ...
                            <div id="closedMessage_pop" data-show="hide" style="display:none">
                            	${close_message_pop}
                            	<br>
								<button type="submit" style="background-color:${userbackground_color_pop};color:${usertext_color_pop};" class="confirm-btn" id="confirm_btn_pop" value="Submit">Confirm</button>
                            ...
                            <div class="chat-type-box" id="chat-type-box">
                                ...
                                <div class="typing-box" id="chat-input">
                                    ...
                                    <p class="" style="margin: 10px 0 5px 0; color:${prompt_theme_text_color_pop};">${prompt_notice_message_pop}</p>                                   
						...
						<div class="chatbot-modal">
							<div class="chatbot-modal-content" id="chatbot_modal_box_pop">
								<span class="chatbot-close-button chatbot-close" id="close_chat_modal_pop">x</span>
								<h1 class="chatbot-heading" style="font-size:16px;">${welcome_message_pop}</h1>
							</div>
						</div>
						<div class="comment-box" id="comment-box-pop" style="display:none" style="background-color:none">
            ...
            if(prompt_is_show_lead_form_pop == 1){                        
                htmlData_pop += `<div class="modal ${chatbot_class_pop} formLead" id="formLead_pop" style="display:none;">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form id="leadForm_pop" class="leadForm" action="" method="POST"> <!-- Wrapped inputs in form -->
                                                ...
                                                <div style="text-align: center">
                                                    <input type="submit" id="lead" class="btn btn-primary px-5" value="Submit" style="color: #fff; background-color:var(--white-color); width: auto;padding: 10px 40px !important; margin: auto;">
                                                </div>
                                            </form>
                                        </div>
                                        <div class="modal-footer">
                                            <div id="footerLead_pop" class="footer">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div id="feedbackmodalForm">
                                                <div class="form-group">
                                                    <textarea id="feedbackMessage_pop" class="form-control style-2" style="height: 104px !important" placeholder="Enter Your Message Here"></textarea>
                                                    <span id="feedback_error_pop"></span>
                                                </div>
                                                <div style="text-align: center">
                                                    <input type="button" id="feedback_pop" class="btn btn-primary px-5 feedback-bot" value="Submit" style="display: inline-block !important; color: #fff; background-color:var(--white-color); width: auto;padding: 10px 40px !important;">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <div id="footerFeedback_pop" class="footer">
                                            </div>
            ...
            const section_pop = document.getElementById("chatbox_pop");
            ...
            if(text_labeling_check_pop){
                if (text_labeling_check_pop == 0) {
                    footer_pop.innerHTML = `<p style="margin: 0; display: flex; justify-content: center; align-items: centerl gap: 10px" >
                                            Powerd By 
                                            <img src="${chatbot_footer_pop}" style="width: 90px; margin-left: 10px; object-fit: contain;">
                                        </p>`;
                    if(footerLead_pop){
                    ...
                    footer_pop.innerHTML = `<a href="${footer_redirect_url_pop}" target="_blank" style="text-decoration:none; font-size:14; color:${font_color_pop}; margin: 0; display: flex; justify-content: center; align-items: centerl gap: 10px" >${chatbot_footer_pop}</a>`;
                    if(footerLead_pop){
                        footerLead_pop.innerHTML = footer_pop.innerHTML;
                    }
                    if(footerFeedback_pop){
			...
			closeMessage_pop.addEventListener("click", function () {
				if (document.getElementById("closedMessage_pop").getAttribute("show") == "show") {
					...
					document.getElementById("chatbox_pop").style.display = "none";
					commentBox_pop.style.display = "block";
					// commentBox_pop.style.background = color;
				}
			});
			...
			var showClick_pop = document.getElementById("showClick_pop");
				...
				document.getElementById("chatbox_pop").style.display = "block";
				commentBox_pop.style.display = "none";
			});
            ...
            if(LeadForm_pop){
                lead_pop.addEventListener('submit', (event) => {
                    ...
                    if (isValid_pop) {
                            ...
                            localStorage.setItem("visitor_form_id_pop", localStorage.getItem('visitor_id'));
            ...
            async function fetchData_pop() {
                try {
                    ...
                    localStorage.setItem("unique_id_pop", localStorage.getItem("visitor_id"));
                    LeadForm_pop.style.display = "none";
                    chatbot_ques_pop.style.display = "none";
                    messages_pop.style.display = "block";
            ...
            function appendBotMessage_pop(gptimg_pop, message_pop, sender_id_pop, reciverType_pop) {
                ...
                let feedBack_pop = document.getElementById("feedback_pop");
                if(feedbackmodal_pop && (delayTime_pop >= 10000)){
                    ...
                    let selectedValue_pop = 3;                    
                    let rate_pop = document.querySelectorAll(".reaction-box li");
                    document.querySelectorAll(".reaction-box li").forEach(li => {
                        selectedValue_pop = li.getAttribute("value");
                        li.addEventListener("click", function () {
                            rate_pop.forEach(item => item.classList.remove("active"));
                            this.classList.add("active");
                            selectedValue_pop = this.getAttribute("value");
                        });
                    });
                    ...
                    feedBack_pop.addEventListener("click", async function (e) {
                        e.preventDefault();
                        const message_pop = document.getElementById("feedbackMessage_pop").value;

                        if (!selectedValue_pop) {
                            alert("Please select an emoji.");
                            return;
                        }

                        if (!message_pop || message_pop === "Enter Your Message Here") {
                            document.getElementById("feedback_error_pop").innerHTML = "Please enter your message.*";
                            return;
                        }
                        try {
                            const formData = new FormData();
                            formData.append("prompt_id", prompt_id_pop);
                            formData.append("visitor_id", localStorage.getItem("visitor_id"));
                            formData.append("selectedValue", selectedValue_pop);
                            formData.append("message", message_pop);
                            ...
                            send_pop.disabled = false;
                            sessionStorage.setItem("visitor_feedback_id_pop", localStorage.getItem("visitor_id"));
                        } catch (error) {
                            console.error("Error:", error);
                        }
                    });
