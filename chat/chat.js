document.addEventListener('DOMContentLoaded', function () {
    ...
    if (localStorage.getItem('visitor_id_chat') === undefined || localStorage.getItem('visitor_id_chat') === '' || localStorage.getItem('visitor_id_chat') === null) {
        const unique_id_chat = localStorage.getItem('visitor_id_chat');
        localStorage.setItem('visitor_id_chat', generateSessionId_chat());
    }
    ...
    async function getStyle_chat() {
        ...
        formData.append('visitor_id', localStorage.getItem('visitor_id_chat'));
        ...
        try {
            ...
            if (json_chat.not_active) {
                ...
                if(chatbot_class_chat == 'manually'){
                    ...
                    manually_form_chat = 'manually-form-chat'
                }else{
                    chatbot_class_chat = json_chat.chatbot_class;
                    color_chat = '';
                    bottext_color_chat = '';
                ...
                console.log(assistant_image_chat);
                
                //Get Images from CDN server to change main baseURL
                const baseUrl1_chat = baseUrl_chat.split('app/')[0];
                const baseUrlImg_chat = 'https://cdn.'+ baseUrl1_chat.split('.')[1] + '.' + baseUrl1_chat.split('.')[2]; 
                if(assistant_image_chat != undefined && assistant_image_chat != '' && assistant_image_chat != 'null'  && assistant_image_chat != null){
                    const myArray = assistant_image_chat.split("/");
                    const lastWord = myArray[myArray.length - 1];
                    if (lastWord != 'default_profile.png') {                        
                        assistant_image_chat = baseUrlImg_chat + assistant_image_chat;
                    } else {
                        assistant_image_chat = baseUrlImg_chat + 'assets/images/default-img.png';
                    }
                } else {
                    assistant_image_chat = baseUrlImg_chat + 'assets/images/default-img.png';
                }
                ...
                if(assistant_image_chat!==undefined && assistant_image_chat != '' && assistant_image_chat!=='null'  && assistant_image_chat!==null){
                    ...
                    widget_image_chat =  baseUrlImg_chat + 'assets/images/widget.png';;
                }
                ...
                if (text_labeling_check_chat) {
                    if (text_labeling_check_chat == 0) {
                        ...
                        boxcolor_chat = json_chat.boxcolor;
        ...
        if (not_active_chat == null || not_active_chat == '') {
            ...
            htmlData_chat = `<link href="${baseUrl_chat}chat/copilot_style.css" rel="stylesheet">
                        ...
                        <style>
                            ...
                            .chat-icons-chat i,.chat-icons-chat span {
                           ...
                           .typing-box-chat button {
                                color:${prompt_theme_text_color_chat};
                            }
                           .typing-box-chat button:hover {
                                color:${usertext_color_chat};
                            }
                            .ques-boxes {
                                max-height: 175px;
                            ...
                            .modal.show-modal .manually-form-chat{
                                background:${color_chat};
                                color:${prompt_theme_text_color_chat};
                            }
                            .leadForm .lead-sub-chat,
                            .feedBackForm .feedback-sub-chat{
                                margin-top: 20px;
                                color:${color_chat};
                                background:${prompt_theme_text_color_chat};
                            }
                            .leadForm .lead-sub-chat:hover,
                            .feedBackForm .feedback-sub-chat:hover{
                                background:${color_chat};
                                color:${prompt_theme_text_color_chat};
                        ...
                        <section class="chat-user-card ${chatbot_class_chat}" id="section_chat">
                            ...
                            <div class="chat-type-box" id="chat-type-box">
                                ...
                                <div class="typing-box typing-box-chat" id='chat-input'>
            ...
            if(prompt_is_show_lead_form_chat == 1){                        
                htmlData_chat += `<div class="modal ${chatbot_class_chat} formLead" id="formLead_chat" style="display:none;">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content ${manually_form_chat}">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form id="leadForm_chat" class="leadForm" action="" method="POST"> <!-- Wrapped inputs in form -->
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name_chat" name="name" class="form-control style-2" placeholder="Enter Your Name">
                                                    <span id="name_error_chat" style="color:red;"></span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="email">Email</label>
                                                    <input type="email" id="email_chat" name="email" class="form-control style-2" placeholder="Enter Your Email">
                                                    <span id="email_error_chat" style="color:red;"></span>
                                                </div>
                                                <div style="text-align: center">
                                                    <input type="submit" class="btn btn-primary px-5 btn-submit lead-sub-chat"  style="display: inline-block !important; width: auto;padding: 10px 40px !important;" value="Submit">
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="feedBackForm" action="" method="POST">
                                                ...
                                                <div id="feedbackmodalForm">
                                                    ...
                                                    <div style="text-align: center">
                                                        <input type="submit" id="feedBackForm_chat" class="btn btn-primary btn-submit px-5 feedback-bot feedback-sub-chat" value="Submit" style="display: inline-block !important; width: auto;padding: 10px 40px !important;">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
            ...
            let copilot_chat = document.getElementById(element_id_chat);            
            copilot_chat.innerHTML += htmlData_chat;
            let delayTime_chat = 60000;
            if(prompt_time_delay_close_chat != 0 && prompt_time_delay_close_chat !=''){
                delayTime_chat = prompt_time_delay_close_chat*1000;
            }
            ...
            if (text_labeling_check_chat) {
                if (text_labeling_check_chat == 0) {
                    footer_chat.innerHTML = `<p style="color:${prompt_theme_text_color_chat}; margin: 0; display: flex; justify-content: center; align-items: center;" >
                                            Powerd By 
                                            <img src="${chatbot_footer_chat}" style="width: 89px;height: 39px; margin-left: 5px; object-fit: contain;">
                                        </p>`;
                    if(footerLead_chat){
                    ...
                    footer_chat.innerHTML = `<a href="${footer_redirect_url_chat}" target="_blank" style="padding: 2px 6px; text-decoration:none; font-size:15; color:${fontcolor_chat}; background:${boxcolor_chat}; margin: 0; display: flex; justify-content: center; align-items: center; gap: 10px;" >${chatbot_footer_chat}</a>`;
                    if(footerLead_chat){
                        footerLead_chat.innerHTML = footer_chat.innerHTML;
                    }
                    if(footerFeedback_chat){
                ...
                footer_chat.innerHTML = `<p style="margin: 0; display: flex; justify-content: center; align-items: center;" >
                                            Powerd By 
                                            <img src="${chatbot_footer_chat}" style="width: 89px;height: 39px; margin-left: 5px; object-fit: contain;">
                                        </p>`;
                if(footerLead_chat){
            ...
            if(LeadForm_chat){
                lead_chat.addEventListener('submit', (event) => {
                    ...
                    if (isValid_chat) {
                            ...
                            localStorage.setItem("visitor_form_id_chat", localStorage.getItem('visitor_id_chat'));
            ...
            async function fetchData_chat() {
                try {
                    ...
                    localStorage.setItem('unique_id_chat', localStorage.getItem('visitor_id_chat'));
                    LeadForm_chat.style.display = "none";
                    chatbot_ques_chat.style.display = "none";
                    startOver_chat.setAttribute('style', `display:inline !important; color:${prompt_theme_text_color_chat}`);
                    messages_chat.style.display = "block";
            ...
            async function addBotMessage_chat(gptimg_chat, message_chat, type_chat, sender_id_chat) {
                ...
                formData.append('app', localStorage.getItem('visitor_id_chat'));
            ...
            function appendBotMessage_chat(gptimg_chat, message_chat, sender_id_chat, reciverType_chat) {
                ...
                let feedBack_chat = document.getElementById('feedBackForm_chat');
                if(feedbackmodal_chat && delayTime_chat >= 10000){
                    ...
                    closeFeedbackModal_chat.addEventListener('click', function () {
                        sessionStorage.setItem("visitor_feedback_id_chat", localStorage.getItem('visitor_id_chat'));
                ...
                if (reciverType_chat === 'regenerate') {
                    ...
                    reciverHTML_chat = `<div class="reciver-text" data-id="${sender_id_chat}">
                                ...
                                <div class="chat-icons chat-icons-chat" style="color:${prompt_theme_text_color_chat};">
