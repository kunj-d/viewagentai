 $(document).ready(function(){
            $('.video_upload_div input[type=file]').drop_uploader({
                uploader_text: 'Drag and drop files upload here &nbsp;',
                browse_text: '',
                browse_css_class: 'button button-primary',
                browse_css_selector: 'file_browse',
                uploader_icon: '<i class="icon icon-upload-video light-grey"></i>',
...
(function($) {
    jQuery.fn.drop_uploader = function(options) {
        ...
        this.each(function(i, val) {
            ...
            $(v).before('<div class="text_wrapper">' + options.uploader_icon + ' <span class="text">' + options.uploader_text + '<div> <a href="#" class="' + options.browse_css_class + ' ' + options.browse_css_selector + '">' + options.browse_text + '</a></div></span></div>');
