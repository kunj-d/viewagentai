(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createView: function (isSearching, setSize, refresh) {
      ...
      function scroll (scrollTop, init) {
        const limitItems = false;   // Flag for limit visual items (TRUE - show only cca first 200 items; FALSE - show all items + code optimization)
        ...
        if(limitItems) {
          ...
          that.selectpicker.view.position1 = that.selectpicker.current.elements.length;
        }
  ...
  //$.fn.selectpicker.Constructor.BootstrapVersion = '5.1';
