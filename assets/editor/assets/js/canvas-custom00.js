				...
				success: function(data){
					...
					if(result.status){
						jQuery.each(result.data, function(k, v) {
							$('.pg-image-list.pg-recent-uploaded.bg').append('<div class="pg-imglist-item"><div class="ed_image pg_canvas_bg_image" data-url="'+ajaxurl+'app/'+v.image_url+'"><img src="'+ajaxurl+'app/'+v.thumb_url+'" alt=""></div><span class="pg-remove-image pg_canvas_bg_remove_image" data-id="'+v.id+'"></span></div>');
							$('.pg-image-list.pg-recent-uploaded.image').append('<div class="pg-imglist-item"><div class="ed_image pg_canvas_add_image" data-url="'+ajaxurl+'app/'+v.image_url+'"><img src="'+ajaxurl+'app/'+v.thumb_url+'" alt=""></div><span class="pg-remove-image pg_canvas_add_remove_image" data-id="'+v.id+'"></span></div>');
						});
